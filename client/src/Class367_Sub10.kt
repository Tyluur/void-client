...
*/
class Class367_Sub10 internal constructor(var_ha_Sub3: ha_Sub3) : Class367(var_ha_Sub3) {
    ...
    override fun method3525(i: Int, bool: Boolean) {
        ...
        if (interface18_impl2 != null && bool) {
            ...
            this.aHa_Sub3_4479.method3853(i xor 0x3b47.inv(), Class348_Sub40_Sub38.aClass251_9477)
    ...
    override fun method3520(i: Byte) {
        ...
        if (aBoolean7385) {
            this.aHa_Sub3_4479.method3897(1, -4382)
            this.aHa_Sub3_4479.method3871(Class150.aClass113_2047, i.toInt() xor 0x57)

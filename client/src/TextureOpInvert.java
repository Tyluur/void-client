...
final class TextureOpInvert extends TextureOp {
    ...
    static final void method3134(int i) {
        ...
        if ((~Class286_Sub5.anInt6248) <= i) {
            ...
            if (Class286_Sub5.anInt6248 > 0) {
                ...
                if (Option_Sub24.aClass299_6098 != (Option_Sub14.aClass190_5990.aClass299_2541)) Class158.aClass299_4938 = (Class60.aToolkit1098.method3706(Option_Sub24.aClass299_6098, (Option_Sub14.aClass190_5990.aClass299_2541), f_6_, Class158.aClass299_4938));
            } else {
    ...
    final int[][] colourOutput(int i, int i_9_) {
        if (i_9_ != -1564599039) method3133((byte) 4);
        anInt9417++;
        int[][] is = this.colourCache.get(-78, i);
        if (this.colourCache.dirty) {
            int[][] is_10_ = this.outputColour((byte) -104, i, 0);
            int[] is_11_ = is_10_[0];
            int[] is_12_ = is_10_[1];
            int[] is_13_ = is_10_[2];
            int[] is_14_ = is[0];
            int[] is_15_ = is[1];
            int[] is_16_ = is[2];
            for (int i_17_ = 0; TextureOpPolarDistortion.width > i_17_; i_17_++) {
    ...
    final int[] monochromeOutput(int i, int i_18_) {
        anInt9420++;
        ...
        if (this.monochromeCache.dirty) {
            ...
            for (int i_20_ = 0; (i_20_ < TextureOpPolarDistortion.width); i_20_++)
                is[i_20_] = 4096 + -is_19_[i_20_];
        }
        return is;
    }

    final void decode(Packet packet, int i, int i_21_) {
        anInt9414++;

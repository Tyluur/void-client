...
// Class111
final class LoadingScreenManager {
    ...
    // method1044
    final boolean hasDefault(int i) {
    ...
    // method1046
    final int[] getSequence(int i, int i_8_) {
        anInt1719++;
    ...
    static final void method1048(Class46 class46, int i) {
        ...
        Option_Sub28.method1843(i_16_, -326, class46, false, i_15_);

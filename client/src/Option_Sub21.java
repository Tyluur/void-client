...
final class Option_Sub21 extends Option {
    ...
    final boolean method1809(int i) {
        ...
        return !this.aClientOptions_3136.method3425(-104);
    }
    ...
    static final void method1810(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_) {
        if (i_5_ != 8 && i_5_ != 16) {
            ...
            int i_16_ = Class348_Sub1_Sub1.aGroundArray8801[i_4_].tileHeight((byte) -86, i_2_, i);
            int i_17_ = Class348_Sub1_Sub1.aGroundArray8801[i_4_].tileHeight((byte) -86, 1 + i_2_, i - -1);
            ...
            int i_10_ = Class348_Sub1_Sub1.aGroundArray8801[i_4_].tileHeight((byte) -86, i_2_, i + 1);
            int i_11_ = Class348_Sub1_Sub1.aGroundArray8801[i_4_].tileHeight((byte) -86, 1 + i_2_, i);
        ...
        try {
            ...
            do {
                ...
                for (; ; ) {
                    ...
                    c_25_ = Option_Sub10.method1765(c_25_, i_18_, 105);
                    c_26_ = Option_Sub10.method1765(c_26_, i_18_, 105);
    ...
    final int method1714(int i, int i_37_) {
        if (i != 3) return 91;
        anInt6064++;
        if (this.aClientOptions_3136.method3425(i ^ ~0x4b)) return 3;
        return 1;
    }

    Option_Sub21(ClientOptions clientOptions) {
        super(clientOptions);
    }

    final void method1716(boolean bool) {
        if (this.aClientOptions_3136.method3425(-112)) this.anInt3138 = 0;
        anInt6057++;
        if (bool != false) aClass318_Sub1Array6066 = null;
        if (this.anInt3138 != 1 && this.anInt3138 != 0) this.anInt3138 = method1710(20014);
    }

    Option_Sub21(int i, ClientOptions clientOptions) {

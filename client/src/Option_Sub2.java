...
final class Option_Sub2 extends Option {
    ...
    final int method1710(int i) {
        ...
        anInt5853++;
        if (!this.aClientOptions_3136.method3425(-76)) return 0;
        return 1;
    }

    Option_Sub2(ClientOptions clientOptions) {
        super(clientOptions);
    }
    ...
    static final void method1725(int i) {
        ...
        for (/**/; ResourceProvider.aFloat3938 >= 16384.0F; ResourceProvider.aFloat3938 -= 16384.0F) {
            /* empty */
        }
        for (/**/; ResourceProvider.aFloat3938 < 0.0F; ResourceProvider.aFloat3938 += 16384.0F) {
            /* empty */
        }
    ...
    Option_Sub2(int i, ClientOptions clientOptions) {

...
final class Class348_Sub23_Sub4 extends Class348_Sub23 {
        ...
        if (this.anInt6868 <= 0 || "SUB".equals(aString9057)) {
            ...
            if (this.anInt6868 <= 8) {
                ...
                if (this.anInt6868 == 0) {
                    ...
                    Packet packet_3_ = new Packet(16);
                    packet.method3389(2147483647, 0, 16, (packet_3_.aByteArray7154));
                    aString9051 = packet_3_.readString((byte) -91);
                    packet_3_.pos = 0;
                    packet.method3389(2147483647, 0, 16, (packet_3_.aByteArray7154));
                    aString9057 = packet_3_.readString((byte) -40);
                }
            } else {
                if (i_2_ == 0) {
                    ...
                    if (i_6_ < 0 || i_6_ > (-packet.pos + (packet.aByteArray7154).length)) throw new IllegalStateException();
                    aString9058 = (Option_Sub17.method1793(packet.aByteArray7154, packet.pos, -123, i_6_));
                }
    ...
    static final void method2987(int i, int i_7_, int i_8_, int i_9_, int i_10_) {
        ...
        if (i_7_ == 8 || i_7_ == 16) {
            ...
            Class357 class357 = Class147.aClass357ArrayArrayArray2029[i][i_10_][i_8_];
            if (class357 != null) {
                if (i_7_ != 1) {
    ...
    static final void method2988(boolean bool) {
        Class60.aToolkit1098.xa(((float) Class316.clientOptions.aClass239_Sub10_7232.method1764(-32350) * 0.1F + 0.7F) * Class160.aFloat2137);
        anInt9049++;
        Class60.aToolkit1098.ZA(Class119_Sub1.anInt4703, Js5TextureSource.aFloat4626, Class361.aFloat4455, (float) (Class21.anInt325 << 2), (float) (Class318_Sub1_Sub3_Sub1.anInt10023 << 2), (float) (Class196.anInt2601 << 2));
        Class60.aToolkit1098.method3653(Class158.aClass299_4938);

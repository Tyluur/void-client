...
final class Class83 {
    ...
    Class83(OpenGLToolkit var_openGLToolkit) {
        ...
        if (this.aBoolean1442) {
            ...
            for (int i = 0; i < 16; i++) {
                ...
                this.aClass258_Sub3Array1444[i] = new Class258_Sub3(var_openGLToolkit, 3553, 6410, 128, 128, true, is, 6410, false);
            }
            ...
            for (int i = 0; i < 16; i++) {
                ...
                this.aClass258_Sub3Array1448[i] = new Class258_Sub3(var_openGLToolkit, 3553, 6410, 128, 128, true, is, 6410, false);
            }
        }
    }
}

...
final class Class5_Sub3 extends Class5 {
    ...
    final void method178(int i, boolean bool, byte i_0_, int i_1_) {
        ...
        anInt8376++;
        Class348_Sub8.active.method3628(-2 + i, i_1_, 4 + this.aClass369_4635.anInt4971, this.aClass369_4635.anInt4963 + 2, (((Class369_Sub1) this.aClass369_4635).anInt8580), 0);
        Class348_Sub8.active.method3628(i + -1, i_1_ + 1, this.aClass369_4635.anInt4971 + 2, this.aClass369_4635.anInt4963, 0, 0);
    }
    ...
    final void method182(int i, int i_8_, int i_9_, boolean bool) {
        ...
        Class348_Sub8.active.KA(i_9_, 2 + i_8_, i_9_ - -i_10_, i_8_ - -(this.aClass369_4635.anInt4963));

...
final class Class348_Sub42_Sub14 extends LinkedNode {
    ...
    final boolean method3236(int[] is, int i, int i_0_, int i_1_, byte i_2_) {
        anInt9623++;
        for (Class348_Sub18 class348_sub18 = (Class348_Sub18) this.aDeque_9629.method1995(4); class348_sub18 != null; class348_sub18 = (Class348_Sub18) this.aDeque_9629.method1990((byte) 117)) {
    ...
    final boolean method3239(boolean bool, int i, int i_6_, int[] is) {
        ...
        for (Class348_Sub18 class348_sub18 = (Class348_Sub18) this.aDeque_9629.method1995(4); class348_sub18 != null; class348_sub18 = (Class348_Sub18) this.aDeque_9629.method1990((byte) 126)) {
    ...
    final void method3240(byte i) {
        ...
        for (Class348_Sub18 class348_sub18 = (Class348_Sub18) this.aDeque_9629.method1995(i + -33); class348_sub18 != null; class348_sub18 = (Class348_Sub18) this.aDeque_9629.method1990((byte) 52)) {
    ...
    static final void method3241(int i, byte i_7_, Toolkit var_toolkit) {
        ...
        if (!TextureOpIrregularBricks.aBoolean9307 || !Class23.aBoolean351) Class348_Sub42_Sub10.anInt9577 = 0;
            ...
            var_toolkit.method3632(TextureOpColourEdgeDetector.anIntArray9436);
            if ((Class306.anInt3872 != (int) ((float) TextureOpColourEdgeDetector.anIntArray9436[0] / 3.0F)) || Class86.anInt1480 != (int) ((float) TextureOpColourEdgeDetector.anIntArray9436[1] / 3.0F)) {
                Class86.anInt1480 = (int) ((float) TextureOpColourEdgeDetector.anIntArray9436[1] / 3.0F);
                Class306.anInt3872 = (int) ((float) TextureOpColourEdgeDetector.anIntArray9436[0] / 3.0F);
            ...
            TextureOpVerticalGradient.aMatrix_9114 = var_toolkit.method3640();
            ...
            if (Class348_Sub42_Sub10.anInt9577 > 0) {
                ...
                for (int i_14_ = 0; (i_14_ < Class348_Sub42_Sub10.anInt9577); i_14_++) {
                    ...
                    TextureOpTexture.method3125(class338.aShortArray4194[3], class338.aShortArray4183[0], class338.aShortArray4194[1], class338.aShortArray4188[3], class338.aShortArray4188[1], (byte) -105, class338.aShortArray4183[1], class338.aShortArray4188[0], class338.aShortArray4194[0], class338.aShortArray4183[3]);
                    TextureOpTexture.method3125(class338.aShortArray4194[3], class338.aShortArray4183[1], class338.aShortArray4194[2], class338.aShortArray4188[3], class338.aShortArray4188[2], (byte) -118, class338.aShortArray4183[2], class338.aShortArray4188[1], class338.aShortArray4194[1], class338.aShortArray4183[3]);
                }
    ...
    final boolean method3242(int[] is, int i, int i_15_, int i_16_) {
        anInt9624++;
        for (Class348_Sub18 class348_sub18 = (Class348_Sub18) this.aDeque_9629.method1995(4); class348_sub18 != null; class348_sub18 = (Class348_Sub18) this.aDeque_9629.method1990((byte) 115)) {
    ...
    static final void method3243(int i, Class348_Sub47 class348_sub47) {
        anInt9630++;
        TextureOpMonochrome.aDeque_9201.method1999(class348_sub47, -20180);

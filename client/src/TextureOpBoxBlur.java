...
final class TextureOpBoxBlur extends TextureOp {
    ...
    final void decode(Packet packet, int i, int i_11_) {
        anInt9460++;
        ...
        do {
            ...
            this.monochrome = packet.readUnsignedByte(i_11_ ^ 0x79d8) == 1;
        } while (false);
    }

    final int[] monochromeOutput(int i, int i_13_) {
        anInt9457++;
        ...
        if (this.monochromeCache.dirty) {
            ...
            for (int i_19_ = -anInt9463 + i; i - -anInt9463 >= i_19_; i_19_++) {
                ...
                int[] is_21_ = new int[TextureOpPolarDistortion.anInt9139];
                int i_22_ = 0;
                for (int i_23_ = -anInt9466; anInt9466 >= i_23_; i_23_++)
                    i_22_ += is_20_[i_23_ & Option_Sub22.anInt6076];
                int i_24_ = 0;
                while (i_24_ < TextureOpPolarDistortion.anInt9139) {
            ...
            for (int i_25_ = 0; TextureOpPolarDistortion.anInt9139 > i_25_; i_25_++) {
                int i_26_ = 0;
    ...
    final int[][] colourOutput(int i, int i_28_) {
        if (i_28_ != -1564599039) return null;
        anInt9462++;
        int[][] is = this.colourCache.get(i_28_ ^ 0x5d41e2a6, i);
        if (this.colourCache.dirty) {
            ...
            for (int i_34_ = i + -anInt9463; i_34_ <= anInt9463 + i; i_34_++) {
                ...
                int[][] is_36_ = new int[3][TextureOpPolarDistortion.anInt9139];
                int i_37_ = 0;
                int i_38_ = 0;
                int i_39_ = 0;
                int[] is_40_ = is_35_[0];
                ...
                int[] is_47_ = is_36_[2];
                int i_48_ = 0;
                while (TextureOpPolarDistortion.anInt9139 > i_48_) {
            ...
            int[] is_51_ = is[1];
            int[] is_52_ = is[2];
            for (int i_53_ = 0; TextureOpPolarDistortion.anInt9139 > i_53_; i_53_++) {
                int i_54_ = 0;
                int i_55_ = 0;
                int i_56_ = 0;

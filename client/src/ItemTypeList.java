...
final class ItemTypeList {
    ...
    static final void method1933(Index index, Toolkit var_toolkit, boolean bool) {
        try {
            anInt3279++;
            IndexedImage[] indexedImages = IndexedImage.method1519(index, Class348_Sub22.hitmarksGroup, 0);
            Class169.aSpriteArray2260 = new Sprite[indexedImages.length];
            ...
            for (int i = 0; indexedImages.length > i; i++)
                Option_Sub2.aSpriteArray5857[i] = var_toolkit.method3691(indexedImages[i], true);
            indexedImages = IndexedImage.method1519(index, Toolkit.headIconsPkGroup, 0);
            Class318_Sub1_Sub1_Sub1.aSpriteArray9959 = new Sprite[indexedImages.length];
            for (int i = 0; indexedImages.length > i; i++)
                Class318_Sub1_Sub1_Sub1.aSpriteArray9959[i] = var_toolkit.method3691(indexedImages[i], true);
            indexedImages = IndexedImage.method1519(index, VarcstrTypeList.headIconsPrayerGroup, 0);
            Class264.aSpriteArray3378 = new Sprite[indexedImages.length];
            for (int i = 0; indexedImages.length > i; i++)
                Class264.aSpriteArray3378[i] = var_toolkit.method3691(indexedImages[i], true);
            indexedImages = IndexedImage.method1519(index, Class115.hintHeadIconsGroup, 0);
            Option_Sub9.aSpriteArray5933 = new Sprite[indexedImages.length];
            for (int i = 0; i < indexedImages.length; i++)
                Option_Sub9.aSpriteArray5933[i] = var_toolkit.method3691(indexedImages[i], true);
            indexedImages = IndexedImage.method1519(index, Class291.hintMapmarkersGroup, 0);
            Class59_Sub1.aSpriteArray5294 = new Sprite[indexedImages.length];
            for (int i = 0; indexedImages.length > i; i++)
                Class59_Sub1.aSpriteArray5294[i] = var_toolkit.method3691(indexedImages[i], true);
            indexedImages = IndexedImage.method1519(index, Class86.mapFlagGround, 0);
            SkyBoxSphereTypeList.aSpriteArray367 = new Sprite[indexedImages.length];
            for (int i = 0; indexedImages.length > i; i++)
                SkyBoxSphereTypeList.aSpriteArray367[i] = var_toolkit.method3691(indexedImages[i], true);
            indexedImages = IndexedImage.method1519(index, Option_Sub10.crossGroup, 0);
            TextureOpBoxBlur.aSpriteArray9467 = new Sprite[indexedImages.length];
            for (int i = 0; i < indexedImages.length; i++)
                TextureOpBoxBlur.aSpriteArray9467[i] = var_toolkit.method3691(indexedImages[i], true);
            indexedImages = IndexedImage.method1519(index, Class113.mapDotsGround, 0);
            Class348_Sub12.aSpriteArray6742 = new Sprite[indexedImages.length];
            for (int i = 0; indexedImages.length > i; i++)
                Class348_Sub12.aSpriteArray6742[i] = var_toolkit.method3691(indexedImages[i], true);
            indexedImages = IndexedImage.method1519(index, Class364.scrollBarGround, 0);
            Class240.aSpriteArray4679 = new Sprite[indexedImages.length];
            for (int i = 0; i < indexedImages.length; i++)
                Class240.aSpriteArray4679[i] = var_toolkit.method3691(indexedImages[i], true);
            indexedImages = IndexedImage.method1519(index, TextureOpClamp.nameIconsGroup, 0);
            Class113.aSpriteArray1744 = new Sprite[indexedImages.length];
            for (int i = 0; indexedImages.length > i; i++)
                Class113.aSpriteArray1744[i] = var_toolkit.method3691(indexedImages[i], true);
            NPCDefinition.aSprite_1365 = var_toolkit.method3691(IndexedImage.loadFirst(index, Class52.compassGroup, 0), bool);
            Option_Sub24.aSprite_6097 = var_toolkit.method3691(IndexedImage.loadFirst(index, (Class186_Sub1.otherLevelGroup), 0), true);
            indexedImages = IndexedImage.method1519(index, Class5_Sub3.hintMapEdgeGroup, 0);
            Class200.aSpriteArray2640 = new Sprite[indexedImages.length];
            for (int i = 0; i < indexedImages.length; i++)
                Class200.aSpriteArray2640[i] = var_toolkit.method3691(indexedImages[i], true);
        } catch (RuntimeException runtimeexception) {
    ...
    final ItemDefinition method1940(int i, int i_13_) {
        ...
        synchronized (aIndex_3267) {
            is = aIndex_3267.file(-1860, Class54.method500(7, i_13_), Class251.method1914(-23590, i_13_));
        }
    ...
    ItemTypeList(Class230 class230, int i, boolean bool, ParamTypeList paramTypeList, Index index, Index index_22_) {
        try {
            ...
            aIndex_3267 = index;
            if (aIndex_3267 != null) {
                int i_23_ = -1 + aIndex_3267.groupSize(-1);
                this.anInt3271 = aIndex_3267.fileLimit(0, i_23_) + i_23_ * 256;

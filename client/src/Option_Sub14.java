...
final class Option_Sub14 extends Option {
    ...
    final void method1716(boolean bool) {
        if (this.aClientOptions_3136.aClass239_Sub3_7222.method1735(bool) && this.anInt3138 == 2) this.anInt3138 = 1;
        anInt5988++;
        if (this.anInt3138 < 0 || this.anInt3138 > 2) this.anInt3138 = method1710(20014);
    }

    Option_Sub14(int i, ClientOptions clientOptions) {
        super(i, clientOptions);
    }

    Option_Sub14(ClientOptions clientOptions) {
        super(clientOptions);
    }
    ...
    static final int method1781(int i, int i_1_, int i_2_) {
        anInt5983++;
        if (JavaSurface.anInt6923 == -1) return 1;

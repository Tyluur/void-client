...
final class Class367_Sub5 extends Class367 {
    ...
    private DirectXToolkit aDirectXToolkit_7328;
    ...
    Class367_Sub5(DirectXToolkit directXToolkit, Index index) {
    ...
    final void method3528(int i) {
        ...
        IDirect3DDevice idirect3ddevice = aDirectXToolkit_7328.anIDirect3DDevice9810;
        int i_0_ = this.aNativeToolkit_4479.method3941(-103);
        Class101_Sub2 class101_sub2 = this.aNativeToolkit_4479.method3887((byte) 61);
        ...
        if (anIDirect3DVertexShader7333 != idirect3dvertexshader) {
            ...
            aDirectXToolkit_7328.method3957(idirect3dvertexshader, (byte) -89);
            method3545(121);
            method3524(-14775);
            method3532(10425);
            method3523((byte) 12);
    ...
    final void method3520(byte i) {
        ...
        if (null != anIDirect3DVertexShader7333) {
            aDirectXToolkit_7328.method3957(null, (byte) -89);
            anIDirect3DVertexShader7333 = null;
        }
    }

    final boolean method3530(int i) {
        if (i > -57) aDirectXToolkit_7328 = null;
        return aBoolean7329;
    }
    ...
    final void method3523(byte i) {
        ...
        if (null != anIDirect3DVertexShader7333) {
            IDirect3DDevice idirect3ddevice = aDirectXToolkit_7328.anIDirect3DDevice9810;
            Class101_Sub2 class101_sub2 = aDirectXToolkit_7328.method3948(i + -22048);
    ...
    final void method3524(int i) {
        if (i == -14775) {
            if (null != anIDirect3DVertexShader7333) {
                IDirect3DDevice idirect3ddevice = aDirectXToolkit_7328.anIDirect3DDevice9810;
                idirect3ddevice.a(4, this.aNativeToolkit_4479.method3835(aFloatArray7337, -101));
            }
        }
    }
    ...
    final void method3527(int i, Interface18 interface18, int i_3_) {
        if (interface18 == null) {
            if (!aBoolean7326) {
                this.aNativeToolkit_4479.method3850((byte) -43, (this.aNativeToolkit_4479.anInterface18_8147));
    ...
    final void method3522(int i) {
        ...
        if (null != anIDirect3DVertexShader7333) {
            ...
            idirect3ddevice.a(11, 1.0F / (float) this.aNativeToolkit_4479.method3833((byte) -58), (float) this.aNativeToolkit_4479.method3826((byte) -70) / 255.0F, this.aNativeToolkit_4479.aFloat8115, 1.0F / (-(this.aNativeToolkit_4479.aFloat8173) + (this.aNativeToolkit_4479.aFloat8115)));
            this.aNativeToolkit_4479.method3894(-28186, this.aNativeToolkit_4479.method3863(-103));
        }
    }
    ...
    private final void method3545(int i) {
        if (i > 95) {
            if (null != anIDirect3DVertexShader7333 && aBoolean7336) {
                Class101_Sub2 class101_sub2 = this.aNativeToolkit_4479.method3854((byte) 111);
                IDirect3DDevice idirect3ddevice = aDirectXToolkit_7328.anIDirect3DDevice9810;
                idirect3ddevice.a(13, ((this.aNativeToolkit_4479.aFloat8093) * (this.aNativeToolkit_4479.aFloat8180)), ((this.aNativeToolkit_4479.aFloat8087) * (this.aNativeToolkit_4479.aFloat8093)), ((this.aNativeToolkit_4479.aFloat8168) * (this.aNativeToolkit_4479.aFloat8093)), 1.0F);
                idirect3ddevice.a(14, ((this.aNativeToolkit_4479.aFloat8174) * (this.aNativeToolkit_4479.aFloat8180)), ((this.aNativeToolkit_4479.aFloat8087) * (this.aNativeToolkit_4479.aFloat8174)), ((this.aNativeToolkit_4479.aFloat8174) * (this.aNativeToolkit_4479.aFloat8168)), 1.0F);
                idirect3ddevice.a(16, ((this.aNativeToolkit_4479.aFloat8180) * (this.aNativeToolkit_4479.aFloat8186)), ((this.aNativeToolkit_4479.aFloat8087) * (this.aNativeToolkit_4479.aFloat8186)), ((this.aNativeToolkit_4479.aFloat8168) * (this.aNativeToolkit_4479.aFloat8186)), 1.0F);
                class101_sub2.method923((this.aNativeToolkit_4479.aFloatArray8170[0]), (this.aNativeToolkit_4479.aFloatArray8170[1]), (byte) -97, (this.aNativeToolkit_4479.aFloatArray8170[2]), aFloatArray7327);
                idirect3ddevice.SetVertexShaderConstantF(15, aFloatArray7327, 1);
                class101_sub2.method923((this.aNativeToolkit_4479.aFloatArray8102[0]), (this.aNativeToolkit_4479.aFloatArray8102[1]), (byte) -99, (this.aNativeToolkit_4479.aFloatArray8102[2]), aFloatArray7327);
    ...
    final void method3531(boolean bool) {
        ...
        if (anIDirect3DVertexShader7333 != null) {
            IDirect3DDevice idirect3ddevice = aDirectXToolkit_7328.anIDirect3DDevice9810;
            Class101_Sub2 class101_sub2 = aDirectXToolkit_7328.method3948(-22036);
            idirect3ddevice.a(0, class101_sub2.method924(11, aFloatArray7337));
        }
    }

                    ...
                    if (i_9_ >= 0 && i_9_ < Class318_Sub7.anInt6451) {
                        for (int i_10_ = i_6_; i_10_ <= i_7_; i_10_++) {
                            if (i_10_ >= 0 && i_10_ < Class348_Sub41.anInt7054 && (!bool || i_9_ >= i_5_ || i_10_ >= i_7_ || i_10_ < i_1_ && i_9_ != i_0_)) {
                                ...
                                if (class357 != null) {
                                    int i_11_ = (((aa_Sub1.aGroundArray5191[i_8_].tileHeight((byte) -86, i_10_, i_9_)) + (aa_Sub1.aGroundArray5191[i_8_].tileHeight((byte) -86, i_10_, i_9_ + 1)) + (aa_Sub1.aGroundArray5191[i_8_].tileHeight((byte) -86, i_10_ + 1, i_9_)) + (aa_Sub1.aGroundArray5191[i_8_].tileHeight((byte) -86, i_10_ + 1, i_9_ + 1))) / 4 - ((aa_Sub1.aGroundArray5191[i].tileHeight((byte) -86, i_1_, i_0_)) + (aa_Sub1.aGroundArray5191[i].tileHeight((byte) -86, i_1_, i_0_ + 1)) + (aa_Sub1.aGroundArray5191[i].tileHeight((byte) -86, i_1_ + 1, i_0_)) + (aa_Sub1.aGroundArray5191[i].tileHeight((byte) -86, i_1_ + 1, i_0_ + 1))) / 4);
                                    ...
                                    if (class318_sub1_sub4 != null && class318_sub1_sub4.method2388(-127))
                                        class318_sub1.method2380(Class9.aToolkit171, i_11_, bool, class318_sub1_sub4, (((i_10_ - i_1_) * Class270.anInt3465) + ((1 - i_3_) * (Class348_Sub23_Sub2.anInt9037))), (byte) -112, (((i_9_ - i_0_) * Class270.anInt3465) + ((1 - i_2_) * (Class348_Sub23_Sub2.anInt9037))));
                                    if (class318_sub1_sub4_12_ != null && class318_sub1_sub4_12_.method2388(-100))
                                        class318_sub1.method2380(Class9.aToolkit171, i_11_, bool, class318_sub1_sub4_12_, (((i_10_ - i_1_) * Class270.anInt3465) + ((1 - i_3_) * (Class348_Sub23_Sub2.anInt9037))), (byte) -115, (((i_9_ - i_0_) * Class270.anInt3465) + ((1 - i_2_) * (Class348_Sub23_Sub2.anInt9037))));
                                    for (Class148 class148 = (class357.aClass148_4396); class148 != null; class148 = (class148.aClass148_2038)) {
                                        ...
                                        if (class318_sub1_sub3 != null && class318_sub1_sub3.method2388(-111) && (i_9_ == (class318_sub1_sub3.aShort8743) || i_9_ == i_4_) && (i_10_ == (class318_sub1_sub3.aShort8750) || i_10_ == i_6_)) {
                                            ...
                                            class318_sub1.method2380(Class9.aToolkit171, i_11_, bool, class318_sub1_sub3, (((class318_sub1_sub3.aShort8750) - i_1_) * Class270.anInt3465 + ((i_14_ - i_3_) * (Class348_Sub23_Sub2.anInt9037))), (byte) -115, (((class318_sub1_sub3.aShort8743) - i_0_) * Class270.anInt3465 + ((i_13_ - i_2_) * (Class348_Sub23_Sub2.anInt9037))));
                                        }
                                    }
                                }
                            }

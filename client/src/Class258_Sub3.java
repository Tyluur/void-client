...
class Class258_Sub3 extends Class258 {
    ...
    Class258_Sub3(OpenGLToolkit var_openGLToolkit, int i, int i_0_, int i_1_, int i_2_) {
        super(var_openGLToolkit, i, i_0_, i_1_ * i_2_, false);
        anInt8545 = -1;
        this.anInt8547 = i_1_;
        this.anInt8551 = i_2_;
        this.aOpenGLToolkit_4851.method3771((byte) -111, this);
    ...
    Class258_Sub3(OpenGLToolkit var_openGLToolkit, int i, int i_6_, int i_7_, int i_8_, boolean bool, float[] fs, int i_9_) {
        super(var_openGLToolkit, i, i_6_, i_8_ * i_7_, bool);
        anInt8545 = -1;
        try {
            this.anInt8547 = i_7_;
            this.anInt8551 = i_8_;
            this.aOpenGLToolkit_4851.method3771((byte) -91, this);
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("tp.<init>(" + (var_openGLToolkit != null ? "{...}" : "null") + ',' + i + ',' + i_6_ + ',' + i_7_ + ',' + i_8_ + ',' + bool + ',' + (fs != null ? "{...}" : "null") + ',' + i_9_ + ')'));
        }
    }
    ...
    final void method1964(boolean bool, int i, int i_10_, int[] is, int i_11_, byte i_12_, int i_13_, int i_14_, int i_15_) {
        ...
        this.aOpenGLToolkit_4851.method3771((byte) -80, this);
        if (i_13_ != i_15_) OpenGL.glPixelStorei(3314, i_15_);
        OpenGL.glTexSubImage2Di(this.anInt4849, 0, i_14_, i_10_, i_13_, i, 32993, (this.aOpenGLToolkit_4851.anInt7812), is, i_11_);
        if (i_13_ != i_15_) OpenGL.glPixelStorei(3314, 0);
        if (i_12_ > -65) this.anInt8547 = 101;
    }

    Class258_Sub3(OpenGLToolkit var_openGLToolkit, int i, int i_21_, int i_22_, int i_23_, boolean bool, int[] is, int i_24_, int i_25_, boolean bool_26_) {
        super(var_openGLToolkit, i, i_21_, i_23_ * i_22_, bool);
        anInt8545 = -1;
        try {
            ...
            this.aOpenGLToolkit_4851.method3771((byte) -79, this);
            if (this.anInt4849 == 34037 || !bool || i_24_ != 0 || i_25_ != 0) {
                OpenGL.glPixelStorei(3314, i_24_);
                OpenGL.glTexImage2Di(this.anInt4849, 0, this.anInt4858, this.anInt8547, this.anInt8551, 0, 32993, this.aOpenGLToolkit_4851.anInt7812, is, 4 * i_25_);
                OpenGL.glPixelStorei(3314, 0);
                this.method1955(false, (byte) -123);
            } else {
                Class353.method3460(this.anInt4849, this.anInt4858, this.anInt8551, this.aOpenGLToolkit_4851.anInt7812, this.anInt8547, is, 32993, -103);
                this.method1955(true, (byte) -123);
            }
            this.method1957(9728, true);
        } catch (RuntimeException runtimeexception) {
            throw Class348_Sub17.method2929(runtimeexception, ("tp.<init>(" + (var_openGLToolkit != null ? "{...}" : "null") + ',' + i + ',' + i_21_ + ',' + i_22_ + ',' + i_23_ + ',' + bool + ',' + (is != null ? "{...}" : "null") + ',' + i_24_ + ',' + i_25_ + ',' + bool_26_ + ')'));
        }
    }

    Class258_Sub3(OpenGLToolkit var_openGLToolkit, int i, int i_32_, int i_33_, int i_34_, boolean bool, byte[] is, int i_35_, boolean bool_36_) {
        super(var_openGLToolkit, i, i_32_, i_33_ * i_34_, bool);
        anInt8545 = -1;
        try {
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("tp.<init>(" + (var_openGLToolkit != null ? "{...}" : "null") + ',' + i + ',' + i_32_ + ',' + i_33_ + ',' + i_34_ + ',' + bool + ',' + (is != null ? "{...}" : "null") + ',' + i_35_ + ',' + bool_36_ + ')'));
        }
    }
    ...
    final void method1967(int i, int i_51_, int i_52_, int i_53_, int i_54_, byte i_55_, int i_56_) {
        anInt8544++;
        int i_57_ = (this.aOpenGLToolkit_4851.anInt7641 + (-i_52_ - i_51_));
        this.aOpenGLToolkit_4851.method3771((byte) -100, this);
    ...
    static final Sprite method1969(byte[] is, int i) {
        ...
        for (; ; ) {
            try {
                ...
                return Class348_Sub8.active.method3662(i_58_, is_60_, (byte) 94, 0, i_58_, i_59_);
    ...
    Class258_Sub3(OpenGLToolkit var_openGLToolkit, int i, int i_77_, int i_78_, int i_79_, int i_80_) {
        super(var_openGLToolkit, i, 6407, i_80_ * i_79_, false);
        anInt8545 = -1;
        this.anInt8547 = i_79_;
        this.anInt8551 = i_80_;
        int i_81_ = (this.aOpenGLToolkit_4851.anInt7641 + (-i_78_ + -i_80_));
        this.aOpenGLToolkit_4851.method3771((byte) -111, this);

...
final class Class321 {
    ...
    private final void method2550(Packet packet, int i, byte i_0_) {
        ...
        if (i != 1) {
            if (i == 2)
                listName = packet.method3371(i_0_ ^ ~0x349a);
            else if (i == 3) {
                int i_1_ = packet.readUnsignedByte(i_0_ ^ 0xcb);
                varps = new int[i_1_][3];
                for (int i_2_ = 0; i_1_ > i_2_; i_2_++) {
                    varps[i_2_][0] = packet.readUnsignedShort(842397944);
                    varps[i_2_][1] = packet.readInt((byte) -126);
                    varps[i_2_][2] = packet.readInt((byte) -126);
                }
            } else if (i == 4) {
                int i_17_ = packet.readUnsignedByte(255);
                varbits = new int[i_17_][3];
                for (int i_18_ = 0; i_17_ > i_18_; i_18_++) {
                    varbits[i_18_][0] = packet.readUnsignedShort(842397944);
                    varbits[i_18_][1] = packet.readInt((byte) -126);
                    varbits[i_18_][2] = packet.readInt((byte) -126);
                }
            } else if (i != 5) {
                    ...
                    if (i != 9) {
                        if (i == 10) {
                            ...
                            for (int i_4_ = 0; i_3_ > i_4_; i_4_++)
                                pathStart[i_4_] = packet.readInt((byte) -126);
                        } else if (i != 12) {
                            if (i == 13) {
                                int i_15_ = packet.readUnsignedByte(255);
                                questRequirements = new int[i_15_];
                                for (int i_16_ = 0; i_16_ < i_15_; i_16_++)
                                    questRequirements[i_16_] = packet.readUnsignedShort(842397944);
                            } else if (i == 14) {
                                int i_13_ = packet.readUnsignedByte(i_0_ ^ 0xcb);
                                skillRequirements = new int[i_13_][2];
                                for (int i_14_ = 0; i_14_ < i_13_; i_14_++) {
                                    skillRequirements[i_14_][0] = packet.readUnsignedByte(255);
                                    skillRequirements[i_14_][1] = (packet.readUnsignedByte(Class348_Sub21.method2955(i_0_, 203)));
                                }
                            } else if (i == 15) packet.readUnsignedShort(842397944);
                            else if (i == 17) this.itemSprite = packet.readUnsignedShort(842397944);
                            else if (i == 18) {
        ...
        } else name = packet.method3371(-13487);
    }

...
final class InputStream_Sub1 extends InputStream {
    ...
    static final boolean method125(int i, int i_0_, int i_1_, Class318_Sub1_Sub4 class318_sub1_sub4, byte i_2_) {
        ...
        int i_5_ = -1 + aa_Sub1.aGroundArray5191[i_1_].tileHeight((byte) -86, i, i_0_);
    ...
    static final void method126(int i) {
        ...
        for (int i_7_ = 0; i_7_ < 4; i_7_++)
            MouseLog.collisionMaps[i_7_].method3500(700);
    ...
    static {
        ...
        for (int i = 1; i <= 10; i++) {
            int i_15_ = -8 + i * 8;
            aLongArray76[i] = (Sprite_Sub2.method993((Sprite_Sub2.method993(Class348_Sub8.method2777(aLongArrayArray75[6][6 + i_15_], 65280L), (Sprite_Sub2.method993(Class348_Sub8.method2777((aLongArrayArray75[5][5 + i_15_]), 16711680L), (Sprite_Sub2.method993((Sprite_Sub2.method993((Sprite_Sub2.method993(Class348_Sub8.method2777((aLongArrayArray75[2][i_15_ + 2]), 280375465082880L), (Sprite_Sub2.method993(Class348_Sub8.method2777(71776119061217280L, (aLongArrayArray75[1][1 + i_15_])), (Class348_Sub8.method2777(aLongArrayArray75[0][i_15_], -72057594037927936L)))))), Class348_Sub8.method2777(1095216660480L, (aLongArrayArray75[3][3 + i_15_])))), Class348_Sub8.method2777((aLongArrayArray75[4][i_15_ - -4]), 4278190080L))))))), Class348_Sub8.method2777(aLongArrayArray75[7][7 + i_15_], 255L)));
        }

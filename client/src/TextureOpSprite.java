...
class TextureOpSprite extends TextureOp {
    ...
    int[][] colourOutput(int i, int i_1_) {
        anInt9239++;
        if (i_1_ != -1564599039) colourOutput(8, -86);
        int[][] is = this.colourCache.get(-108, i);
        if (this.colourCache.dirty && method3090(true)) {
            int[] is_2_ = is[0];
            int[] is_3_ = is[1];
            int[] is_4_ = is[2];
            ...
            if (TextureOpPolarDistortion.anInt9139 == this.anInt9237) {
                ...
                for (int i_8_ = 0; (TextureOpPolarDistortion.anInt9139 > i_8_); i_8_++) {
                    int i_9_ = (this.anInt9237 * i_8_ / TextureOpPolarDistortion.anInt9139);

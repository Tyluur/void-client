...
abstract class Option {
    ...
    ClientOptions aClientOptions_3136;
    ...
    static final void method1713(boolean bool, int i) {
        Option_Sub3.method1728(Class348_Sub42_Sub8_Sub2.anInt10432, -1, r.anInt9721, bool, Class321.anInt4017);
        if (i == 520) anInt3137++;
    }
    ...
    Option(ClientOptions clientOptions) {
        this.aClientOptions_3136 = clientOptions;
    ...
    Option(int i, ClientOptions clientOptions) {
        this.aClientOptions_3136 = clientOptions;
        this.anInt3138 = i;
    }

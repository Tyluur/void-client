...
final class SecondaryLinkedList {
    ...
    static final void method1007(Class46 class46, Toolkit var_toolkit, int i, int i_1_, int i_2_) {
        try {
            anInt1648++;
            aa var_aa = class46.method425(var_toolkit, (byte) 40);
            if (var_aa != null) {
                if (i_2_ != 22960) anIntArray1650 = null;
                var_toolkit.KA(i, i_1_, i + class46.anInt709, class46.anInt789 + i_1_);
                        ...
                        if (class348_sub22 != null) {
                            ...
                            if (npc.method2445((byte) -126) && ((npc.plane) == (Class132.aPlayer_1907.plane))) {
                                ...
                                if (NPCDefinition != null && NPCDefinition.aBoolean1397 && NPCDefinition.aBoolean1396) {
                                    ...
                                    if (NPCDefinition.anInt1383 != -1) Class318_Sub1.method2385(class46, i_1_, var_aa, NPCDefinition.anInt1383, i_23_, i, (byte) -73, i_24_, var_toolkit);
                    ...
                    for (int i_26_ = 0; i_26_ < i_25_; i_26_++) {
                        ...
                        if (player != null && player.method2457((byte) 37) && !player.aBoolean10551 && (Class132.aPlayer_1907 != player) && (player.plane == (Class132.aPlayer_1907.plane))) {
                            ...
                            if (!player.aBoolean10554) {
                                if (!bool) {
                                    if (bool_30_) Class151.method1211(i_1_, (Class348_Sub12.aSpriteArray6742[5]), i, class46, var_aa, i_28_, i_2_ + -22958, i_27_);
                                    else if (!bool_32_) Class151.method1211(i_1_, (Class348_Sub12.aSpriteArray6742[2]), i, class46, var_aa, i_28_, 2, i_27_);
                                    else Class151.method1211(i_1_, (Class348_Sub12.aSpriteArray6742[4]), i, class46, var_aa, i_28_, 2, i_27_);
                                } else Class151.method1211(i_1_, (Class348_Sub12.aSpriteArray6742[3]), i, class46, var_aa, i_28_, 2, i_27_);
                            } else Class151.method1211(i_1_, (Class348_Sub12.aSpriteArray6742[6]), i, class46, var_aa, i_28_, i_2_ + -22958, i_27_);
                        }
                    }
            ...
            throw Class348_Sub17.method2929(runtimeexception, ("mn.F(" + (class46 != null ? "{...}" : "null") + ',' + (var_toolkit != null ? "{...}" : "null") + ',' + i + ',' + i_1_ + ',' + i_2_ + ')'));
        }
    }
    ...
    static final void method1010(boolean bool, boolean bool_42_) {
        r.aMatrix_9720.method898(Class21.aToolkit326.method3640());
        anInt1642++;
        int[] is = Class21.aToolkit326.Y();

...
final class Class293 implements Runnable {
    ...
    private final Toolkit aToolkit3746;
    ...
    private final void method2207() {
        aToolkit3746.method3659(anInt3749);
        while (!aBoolean3750 && aBoolean3745) {
            if (aClass315_3743 == null || aClass315_3743.method2360(-112)) {
                ...
                if (class318 instanceof Class318_Sub1) {
                    ...
                    if (class318_sub1.aBoolean6387) class318_sub1.method2387(Class9.aToolkit171, -127);
                    else {
                    ...
                    if (i >= 1 && i <= 4) {
                        Ground var_ground = aa_Sub1.aGroundArray5191[i - 1];
                        for (int i_0_ = 0; i_0_ < (Class318_Sub1_Sub4_Sub1.anInt10084 + Class318_Sub1_Sub4_Sub1.anInt10084); i_0_++) {
                            for (int i_1_ = 0; i_1_ < (Class318_Sub1_Sub4_Sub1.anInt10084 + Class318_Sub1_Sub4_Sub1.anInt10084); i_1_++) {
                                if (Class115.aBooleanArrayArrayArray1751[i - 1][i_0_][i_1_]) {
                                    ...
                                    if (i_2_ >= 0 && i_2_ < var_ground.anInt4587 && i_3_ >= 0 && i_3_ < var_ground.anInt4590) {
                                        Class9.aToolkit171.H(i_2_ << Class362.anInt4459, var_ground.tileHeight((byte) -86, i_3_, i_2_), i_3_ << Class362.anInt4459, anIntArray3747);
                                        if (Class286_Sub4.method2154(anIntArray3747[0]) == anInt3749 - 1) var_ground.method3979(i_2_, i_3_);
                                    }
                                }
                            }
                        }
        ...
        aToolkit3746.method3678(anInt3749);
        while (aBoolean3750 && aBoolean3745) {
            synchronized (this) {
                try {
                    this.wait();
    ...
    Class293(int i, Toolkit var_toolkit) {
        anIntArray3747 = new int[3];
        aBoolean3750 = true;
        aBoolean3745 = true;
        aBoolean3744 = false;
        anInt3749 = i;
        aToolkit3746 = var_toolkit;
    }
}

...
final class TextureOp37 extends TextureOp {
    ...
    final void decode(Packet packet, int i, int i_13_) {
        anInt9268++;
        if (i_13_ != 31015) monochromeOutput(72, 12);
        int i_14_ = i;
        while_183_:
        do {
            while_182_:
    ...
    static final long method3107(byte i, Interface10 interface10, int i_15_, int i_16_) {
        ...
        Class51 class51 = TextureOpColourGradient.objectTypeList.method2005(0, interface10.method42(-107));

...
final class TextureOpColourGradient extends TextureOp {
    ...
    final void decode(Packet packet, int i, int i_0_) {
        if (i == 0) {
            ...
            } else setDefaults(i_1_, i_0_ + -31111);
        }
        anInt9190++;
    ...
    static final void method3076(int i, boolean bool) {
        anInt9198++;
        Class316.clientOptions.update((byte) 74, (Class316.clientOptions.aClass239_Sub27_7255), 0);
        Class316.clientOptions.update((byte) 74, (Class316.clientOptions.aClass239_Sub27_7261), 0);
        ...
        Class316.clientOptions.update((byte) 74, (Class316.clientOptions.aClass239_Sub4_7220), 0);
        Class316.clientOptions.update((byte) 74, (Class316.clientOptions.aClass239_Sub16_7247), 0);
        Class316.clientOptions.update((byte) 74, (Class316.clientOptions.aClass239_Sub9_7256), 0);
        ...
        Class316.clientOptions.update((byte) 74, (Class316.clientOptions.aClass239_Sub6_7226), i);
        ...
        Class316.clientOptions.update((byte) 74, (Class316.clientOptions.aClass239_Sub29_7229), 1);
        TextureOp.updateFeatureMask(-1);
        Class76.method773(true);
        RuntimeException_Sub1.aBoolean4604 = true;
    }

    final int[][] colourOutput(int i, int i_3_) {
        anInt9192++;
        int[][] is = this.colourCache.get(i_3_ ^ 0x5d41e287, i);
    ...
    final void finish(int i) {
        if (i >= 108) {
            anInt9196++;
            if (anIntArrayArray9194 == null) setDefaults(1, -97);
            method3079(-29547);
        }
    }

    // method3078
    private final void setDefaults(int i, int i_10_) {
        anInt9193++;
        int i_11_ = i;
        if (i_11_ == 1) {
    ...
    public TextureOpColourGradient() {
        super(1, false);
    }
}

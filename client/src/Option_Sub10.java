...
final class Option_Sub10 extends Option {
    ...
    static int crossGroup;

    Option_Sub10(int i, ClientOptions clientOptions) {
    ...
    static final void method1760(int i, int i_0_, boolean bool, int i_1_, byte i_2_, int i_3_, int i_4_, int i_5_) {
        ...
        anInt5940++;
        if ((bool ? Class316.clientOptions.aClass239_Sub26_7215.method1838(-32350) : Class316.clientOptions.aClass239_Sub26_7272.method1838(-32350)) != 0 && i_3_ != 0 && Class147.anInt2021 < 50 && i != -1)
    ...
    static final void method1761(int i) {
        anInt5935++;
        Class348_Sub47.method3324(Class348_Sub8.active, (byte) 105, Class367_Sub11.anInt7396);
    ...
    Option_Sub10(ClientOptions clientOptions) {
        super(clientOptions);
    }
}

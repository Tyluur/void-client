...
final class Option_Sub4 extends Option {
    ...
    final boolean method1736(int i) {
        anInt5873++;
        if (this.aClientOptions_3136.method3425(-80)) return false;
        if (i < 85) method1716(true);
        return this.aClientOptions_3136.method3422(674) == Class10.aClass230_186;
    }

    Option_Sub4(ClientOptions clientOptions) {
        super(clientOptions);
    }
    ...
    final int method1714(int i, int i_2_) {
        ...
        anInt5872++;
        if (this.aClientOptions_3136.method3425(-63)) return 3;
        if (this.aClientOptions_3136.method3422(674) == Class10.aClass230_186) return 1;
        return 3;
    }
    ...
    Option_Sub4(int i, ClientOptions clientOptions) {

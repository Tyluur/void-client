...
final class TextureOpColourEdgeDetector extends TextureOp {
    ...
    static final void method3141(boolean bool, byte i) {
        ...
        TextureOpTiledSprite.method3093(i + 79);
        ...
        LinkedNode.method3163((byte) -114);
    ...
    final void decode(Packet packet, int i, int i_5_) {
        do {
            try {
    ...
    public TextureOpColourEdgeDetector() {
        super(1, false);
    }
    ...
    final int[][] colourOutput(int i, int i_7_) {
        anInt9434++;

...
final class Class310_Sub1 extends Class310 implements Interface18_Impl2 {
    ...
    public final void method63(byte i) {
        this.aDirectXToolkit_3893.method3956((byte) -128, this);
        if (i > -21) method2314(88);
    }

    Class310_Sub1(DirectXToolkit directXToolkit, int i, boolean bool, int[][] is) {
        super(directXToolkit, Class108.aClass304_1662, Class68.aClass68_1183, bool && directXToolkit.aBoolean9802, 6 * i * i);
        anInt6329 = i;
        if (this.aBoolean3892) anIDirect3DCubeTexture6330 = this.aDirectXToolkit_3893.anIDirect3DDevice9810.a(anInt6329, 0, 1024, 21, 1);
        else anIDirect3DCubeTexture6330 = this.aDirectXToolkit_3893.anIDirect3DDevice9810.a(anInt6329, 1, 0, 21, 1);

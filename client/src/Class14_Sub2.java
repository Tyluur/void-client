        ...
        try {
            ...
            if (bool) {
                ...
                for (int i_0_ = 0; i_0_ < 6; i_0_++)
                    OpenGL.glTexImage2Di(34069 + i_0_, 0, this.method228(121), i, i, 0, TextureOpBinary.method3055(110, this.aClass304_5084), (this.aOpenGLxToolkit_5082.anInt9918), is[i_0_], 0);
            }
    ...
    static final void saveOptions(int i) {
        ...
        try {
            ...
            if (class144.anInt1997 == 1) {
                ...
                Packet packet = Class316.clientOptions.method3427(24);
                class234.method1658((byte) 114, 0, (packet.pos), (packet.aByteArray7154));
            }

    ...
    static final void method128(Class74 class74, byte i) {
        try {
            ...
            if (class74 == Class348_Sub26.aClass74_6891) {
                ...
                if (Class282.method2112(126, Class312.anInt3931) || (i_6_ >= 0 && i_7_ >= 0 && Class367_Sub4.mapLength > i_6_ && (i_7_ < TextureOpBinary.mapWidth))) Class348_Sub12.method2800(TextureOpColourGradient.anInt9200, 0, i_7_, -1, i_1_, i_3_, i_2_, i_4_, (byte) 121, i_6_);
            } else if (class74 == TextureOpClamp.aClass74_9475) {
                ...
                if (i_9_ >= 0 && i_10_ >= 0 && i_9_ < Class367_Sub4.mapLength && TextureOpBinary.mapWidth > i_10_) {
                ...
                if (i_19_ >= 0 && i_20_ >= 0 && i_19_ < Class367_Sub4.mapLength && (i_20_ < TextureOpBinary.mapWidth)) {
                    int i_28_ = 1 + i_23_;
                    if (((Class132.aPlayer_1907.anIntArray10320[0]) >= i_19_ + -i_28_) && i_28_ + i_19_ >= (Class132.aPlayer_1907.anIntArray10320[0]) && ((Class132.aPlayer_1907.anIntArray10317[0]) >= -i_28_ + i_20_) && i_20_ + i_28_ >= (Class132.aPlayer_1907.anIntArray10317[0]))
                        Option_Sub10.method1760(i_21_, i_26_, false, ((i_20_ << 8) + (((TextureOpColourGradient.anInt9200) << 24) + ((i_19_ << 16) - -i_23_))), (byte) -98, i_24_, i_27_, i_25_);
                }
                ...
                TextureOpColourGradient.objectTypeList.method2005(0, i_29_).method478(i_30_, -31076);
                ...
                if (i_32_ >= 0 && i_33_ >= 0 && i_32_ < Class367_Sub4.mapLength && i_33_ < TextureOpBinary.mapWidth) {
                    int i_41_ = i_36_ + 1;
                    if ((Class132.aPlayer_1907.anIntArray10320[0]) >= i_32_ - i_41_ && (Class132.aPlayer_1907.anIntArray10320[0]) <= i_41_ + i_32_ && ((Class132.aPlayer_1907.anIntArray10317[0]) >= -i_41_ + i_33_) && (i_33_ - -i_41_ >= (Class132.aPlayer_1907.anIntArray10317[0])))
                        Class37.method358(i_37_, (i_36_ + (i_33_ << 8) + ((TextureOpColourGradient.anInt9200 << 24) + (i_32_ << 16))), i_38_, i_39_, i_40_, i_34_, -29494);
                }
                ...
                NativeToolkit.method3824(i_45_, i_42_, i_47_, i_44_, i_48_, 115, TextureOpColourGradient.anInt9200, i_49_);
                ...
                if (i_51_ >= 0 && i_52_ >= 0 && (i_51_ < 2 * Class367_Sub4.mapLength) && (i_52_ < Class367_Sub4.mapLength * 2) && i_56_ >= 0 && i_57_ >= 0 && (i_56_ < TextureOpBinary.mapWidth * 2) && 2 * TextureOpBinary.mapWidth > i_57_ && i_60_ != 65535) {
                    i_57_ *= 256;
                    i_56_ = 256 * i_56_;
                    i_62_ <<= 2;
                    i_51_ = 256 * i_51_;
                    ...
                    if (i_58_ != 0 && i_55_ != -1) {
                        ...
                        if (i_58_ < 0) {
                            int i_67_ = -i_58_ + -1;
                            if (Class348_Sub42_Sub11.index != i_67_) class318_sub1_sub3_sub3 = (Class294.aPlayerArray5058[i_67_]);
                ...
                boolean bool = (i_80_ >= 0 && i_78_ >= 0 && Class367_Sub4.mapLength > i_80_ && TextureOpBinary.mapWidth > i_78_);
                if (bool || Class282.method2112(124, Class312.anInt3931)) {
                    Class352.method3459(new Class348_Sub34(i_76_, i_75_), TextureOpColourGradient.anInt9200, i_79_, i_81_, -2);
                    if (bool) Class203.method1479(i_78_, (byte) -124, i_80_, TextureOpColourGradient.anInt9200);
                }
                ...
                if (Class282.method2112(i ^ 0x73, Class312.anInt3931) || (i_87_ >= 0 && i_88_ >= 0 && Class367_Sub4.mapLength > i_87_ && (i_88_ < TextureOpBinary.mapWidth))) Class348_Sub12.method2800(TextureOpColourGradient.anInt9200, 0, i_88_, -1, i_83_, i_85_, i_84_, -1, (byte) 125, i_87_);
            } else {
                ...
                if (Class39.aClass74_515 == class74) {
                    ...
                    if (Class130.aClass356_1895 != null) {
                        ...
                        if (class348_sub37 != null) {
                            ...
                            if (i_92_ >= 0 && i_90_ >= 0 && (i_92_ < Class367_Sub4.mapLength) && (TextureOpBinary.mapWidth > i_90_)) Class203.method1479(i_90_, (byte) -125, i_92_, (TextureOpColourGradient.anInt9200));
                        }
                    }
                    ...
                    if (i_104_ != Class348_Sub42_Sub11.index) {
                        boolean bool = (i_101_ >= 0 && i_99_ >= 0 && (i_101_ < Class367_Sub4.mapLength) && (i_99_ < TextureOpBinary.mapWidth));
                        if (bool || Class282.method2112(122, Class312.anInt3931)) {
                            Class352.method3459(new Class348_Sub34(i_103_, i_97_), TextureOpColourGradient.anInt9200, i_100_, i_102_, i + -10);
                            if (bool) Class203.method1479(i_99_, (byte) -120, i_101_, (TextureOpColourGradient.anInt9200));
                        }
                    }
                    ...
                    if (i_106_ >= 0 && i_107_ >= 0 && (i_106_ < Class367_Sub4.mapLength) && i_107_ < TextureOpBinary.mapWidth && i_108_ >= 0 && i_109_ >= 0 && Class367_Sub4.mapLength > i_108_ && (TextureOpBinary.mapWidth > i_109_) && i_111_ != 65535) {
                        i_117_ <<= 2;
                    ...
                    JavaBillboardFace.method205(i_121_, i_119_, i_123_, string, i_122_, -109, i_120_, TextureOpColourGradient.anInt9200);
                } else {

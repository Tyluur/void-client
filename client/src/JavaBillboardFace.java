...
final class JavaBillboardFace {
    ...
    static final void method203(int i, int i_0_, int i_1_, int i_2_, int i_3_) {
        ...
        Class135_Sub2.method1156(-27, i_8_, AnimationType.anIntArrayArray255[i_2_], i_9_, i_1_);
        while (i_5_ > i_4_) {
            i_7_ += 2;
            i_6_ += i_7_;
            if (i_6_ > 0) {
                ...
                if (i_11_ >= Class132.anInt1910 && Class38.anInt513 >= i_10_) {
                    ...
                    if (i_11_ <= Class38.anInt513) Class135_Sub2.method1156(-27, i_12_, (AnimationType.anIntArrayArray255[i_11_]), i_13_, i_1_);
                    if (Class132.anInt1910 <= i_10_) Class135_Sub2.method1156(-27, i_12_, (AnimationType.anIntArrayArray255[i_10_]), i_13_, i_1_);
                }
            }
            int i_14_ = -++i_4_ + i_2_;
            int i_15_ = i_2_ - -i_4_;
            if (Class132.anInt1910 <= i_15_ && Class38.anInt513 >= i_14_) {
                ...
                if (i_15_ <= Class38.anInt513) Class135_Sub2.method1156(-27, i_16_, AnimationType.anIntArrayArray255[i_15_], i_17_, i_1_);
                if (i_14_ >= Class132.anInt1910) Class135_Sub2.method1156(-27, i_16_, AnimationType.anIntArrayArray255[i_14_], i_17_, i_1_);
            }
        }
    }
    ...
    static final void method204(int i) {
        anInt155++;
        while (Class299.aClass348_Sub49_Sub2_3813.method3415(-62, TextureOpMandelbrot.anInt9341) >= 15) {
            ...
            Class74.anIntArray1233[IDKTypeList.anInt2057++] = i_18_;
            ...
            try {
                ...
                if (Class369_Sub2.anInt8587 > 0) {
                    ...
                    for (int i_41_ = Class284.anInt3676; ((i_41_ < i_37_ + Class284.anInt3676) && Class369_Sub2.anInt8587 > i_41_); i_41_++) {
                        String[] strings = (TextureOpIrregularBricks.method3113('\010', true, Class286_Sub1.aStringArray6200[i_41_]));
                ...
                Deque.aFontRenderer_3326.method2576("--> " + Class250.method1909((byte) 31, Class363.aString4461), -1, (i_36_ - (-350 + Class369.aFontMetrics_4962.bottomPadding) - 1), 10 + i_35_, -16777216, -127);

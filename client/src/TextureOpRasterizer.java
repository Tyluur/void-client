...
final class TextureOpRasterizer extends TextureOp {
    ...
    final int[] monochromeOutput(int i, int i_5_) {
        anInt9486++;
        int[] is = this.monochromeCache.get(i_5_ + -255, i);
        if (this.monochromeCache.dirty) method3151(this.monochromeCache.get((byte) 16), (byte) -27);
        if (i_5_ != 255) decode(null, 66, -50);
        return is;
    }

    static final void method3153(int i) {
        anInt9482++;
        for (Class348_Sub42_Sub13 class348_sub42_sub13 = ((Class348_Sub42_Sub13) Class233.aSecondaryLinkedList_3022.method1011(-49)); class348_sub42_sub13 != null; class348_sub42_sub13 = ((Class348_Sub42_Sub13) Class233.aSecondaryLinkedList_3022.next((byte) 51))) {
            if (class348_sub42_sub13.anInt9615 > 1) {
                class348_sub42_sub13.anInt9615 = 0;
                VarcTypeList.aClass60_3301.method582(class348_sub42_sub13, ((Class348_Sub42_Sub12) class348_sub42_sub13.aSecondaryLinkedList_9621.nextPrevious.secondaryNext).aLong9600, (byte) -108);
                class348_sub42_sub13.aSecondaryLinkedList_9621.clear(i ^ 0x7dc976c2);
            }
        }
        Class8.anInt166 = 0;
        Class73.anInt4776 = i;
        TextureOpVerticalGradient.aDeque_9111.clear(125);
        ...
        if (i == 0) {
            ...
            for (int i_7_ = 0; aClass50Array9481.length > i_7_; i_7_++) {
                ...
                do {
                    ...
                    aClass50Array9481[i_7_] = (TextureOp.method3036(packet, Class348_Sub21.method2955(i_6_, -31102)));
                    continue while_216_;
                } while (false);
                aClass50Array9481[i_7_] = Class265.method2022(packet, 0);
            }
        } else if (i == 1) this.monochrome = packet.readUnsignedByte(255) == 1;
        anInt9484++;
    }

    final int[][] colourOutput(int i, int i_10_) {
        anInt9483++;

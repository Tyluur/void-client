...
final class Option_Sub15 extends Option {
    ...
    final void method1716(boolean bool) {
        ...
        anInt5999++;
        if (this.aClientOptions_3136.method3428((byte) -84).method1458(-23688) < 96) this.anInt3138 = 0;
    ...
    final int method1714(int i, int i_1_) {
        ...
        if (this.aClientOptions_3136.method3428((byte) -85).method1458(-23688) < 96) return 3;
        return 1;
    }

    Option_Sub15(int i, ClientOptions clientOptions) {
    ...
    static final void method1783(int i, int i_2_, int i_3_, int i_4_, int i_5_, int i_6_) {
        ...
        if ((~i_8_) == i_2_) {
            ...
            TextureMetrics.method223(i_5_, i_6_, i_3_, i, (byte) 47);
            return;
        }
        if (i_7_ < 0) i_7_ = -i_7_;
        if (i_8_ < 0) i_8_ = -i_8_;
    ...
    final int method1710(int i) {
        ...
        if (this.aClientOptions_3136.method3428((byte) -105).method1458(-23688) < 96) return 0;
        return 2;
    }

    Option_Sub15(ClientOptions clientOptions) {
        super(clientOptions);
    ...
    final boolean method1786(int i) {
        ...
        anInt6001++;
        return this.aClientOptions_3136.method3428((byte) -104).method1458(-23688) >= 96;
    }

...
final class Class348_Sub40_Sub7 extends Class348_Sub40 {
    ...
    static final void method3064(int i, int i_10_, boolean bool, int i_11_, int i_12_, int i_13_, int i_14_, boolean bool_15_, Class46[] class46s, int i_16_, int i_17_) {
        try {
            Class348_Sub8.aToolkit6654.KA(i, i_12_, i_14_, i_17_);
            if (bool_15_ == false) {
                anInt9145++;
                int i_18_ = 0;
                            ...
                            if (i_31_ < i_34_ && i_32_ < i_33_) {
                                if (class46.anInt765 != 0) {
                                    ...
                                    if (class46.anInt765 == Class290.anInt3717) {
                                        if (class46.method425((Class348_Sub8.aToolkit6654), (byte) 8) != null) {
                                            Class369_Sub1.method3570(false);
                                            Class107.method1007(class46, (Class348_Sub8.aToolkit6654), i_24_, i_25_, 22960);
                                    ...
                                    if (class46.anInt765 == SafeModeOption.anInt5951) {
                                        if (class46.method425((Class348_Sub8.aToolkit6654), (byte) 26) != null) {
                                    ...
                                    if (class46.anInt765 == Class348_Sub45.anInt7102) {
                                        Class318_Sub1_Sub3_Sub4.method2464((byte) -7, i_24_, class46.anInt709, class46.anInt789, Class348_Sub8.aToolkit6654, i_25_, Class348_Sub40_Sub4.js5TextureSource);
                                        Class152.aBooleanArray2076[i_23_] = true;
                                        Class348_Sub8.aToolkit6654.KA(i, i_12_, i_14_, i_17_);
                                        continue;
                                    }
                                    if (Class218.anInt2861 == class46.anInt765) {
                                        Class361.method3498(class46.anInt789, Class348_Sub8.aToolkit6654, i_24_, class46.anInt709, true, i_25_);
                                        Class152.aBooleanArray2076[i_23_] = true;
                                        Class348_Sub8.aToolkit6654.KA(i, i_12_, i_14_, i_17_);
                                        continue;
                                    }
                                    if (Class136.anInt4793 == class46.anInt765) {
                                        if (Class298.aBoolean3811 || Class188.aBoolean2514) {
                                            ...
                                            if (Class298.aBoolean3811) {
                                                ...
                                                i_38_ += 15;
                                                int i_43_ = (Class348_Sub8.aToolkit6654.E() / 1024);
                                            ...
                                            if (Class188.aBoolean2514) {
                                                Class240.aFontRenderer_4684.method2569(("Polys: " + Class348_Sub8.aToolkit6654.I() + " Models: " + Class348_Sub8.aToolkit6654.M()), i_38_, -256, i_37_, -127, -1);
                                                i_38_ += 12;
                                ...
                                if (class46.anInt774 == 0) {
                                    if ((class46.anInt765 == Class372.anInt4532) && Class348_Sub8.aToolkit6654.method3666()) Class348_Sub8.aToolkit6654.method3658(i_24_, i_25_, class46.anInt709, class46.anInt789);
                                    ...
                                    if ((class46.anInt765 == Class372.anInt4532) && Class348_Sub8.aToolkit6654.method3666()) Class348_Sub8.aToolkit6654.method3698();
                                    Class348_Sub8.aToolkit6654.KA(i, i_12_, i_14_, i_17_);
                                }
                                if (Class175.aBooleanArray2326[i_23_] || ha_Sub3.anInt8045 > 1) {
                                    if (class46.anInt774 == 3) {
                                        if (i_28_ == 0) {
                                            if (class46.aBoolean810) Class348_Sub8.aToolkit6654.aa(i_24_, i_25_, (class46.anInt709), (class46.anInt789), (class46.anInt749), 0);
                                            else Class348_Sub8.aToolkit6654.method3628(i_24_, i_25_, (class46.anInt709), (class46.anInt789), (class46.anInt749), 0);
                                        } else if (!class46.aBoolean810) Class348_Sub8.aToolkit6654.method3628(i_24_, i_25_, class46.anInt709, class46.anInt789, (0xffffff & class46.anInt749 | (-(i_28_ & 0xff) + 255 << 24)), 1);
                                        else Class348_Sub8.aToolkit6654.aa(i_24_, i_25_, class46.anInt709, class46.anInt789, (0xffffff & class46.anInt749 | (-(0xff & i_28_) + 255 << 24)), 1);
                                        if (Class59_Sub1.aBoolean5300) {
                                            if (bool) Class338.method2663(-5590, i_19_, i_21_, i_20_, i_22_);
                                            else Class54.method503(i_22_, i_19_, (byte) -74, i_21_, i_20_);
                                        }
                                    } else if (class46.anInt774 == 4) {
                                        FontRenderer fontRenderer = class46.method426((Class348_Sub8.aToolkit6654), (byte) 68);
                                        if (fontRenderer == null) {
                                            ...
                                            if (Class49.aClass46_4730 == class46) {
                                                string = (Class274.aClass274_3514.method2063((Class348_Sub33.language), 544));
                                                i_50_ = (class46.anInt749);
                                            }
                                            if (Class318_Sub1_Sub3_Sub2.aBoolean10046) Class348_Sub8.aToolkit6654.T(i_24_, i_25_, (class46.anInt709) + i_24_, (class46.anInt789) + i_25_);
                                            ...
                                            if (string.trim().length() > 0) {
                                                if (Class318_Sub1_Sub3_Sub2.aBoolean10046) {
                                                    ...
                                                    FontMetrics fontMetrics = (Class135.method1151(-25411, (Class348_Sub8.aToolkit6654), (class46.anInt702)));
                                        ...
                                        if (class46.anInt705 >= 0)
                                            class46.method444(bool_15_, Class123.skyBoxSphereTypeList, Class30.skyBoxTypeList).method2293(0, Class348_Sub8.aToolkit6654, (byte) -35, i_24_, class46.anInt709, i_25_, (class46.anInt835 << 3), (class46.anInt759 << 3), 0, class46.anInt789);
                                        else {
                                            Sprite sprite;
                                            if (class46.anInt812 != -1) {
                                                Class154 class154 = ((class46.aBoolean720) ? (Class132.aPlayer_1907.aClass154_10536) : null);
                                                sprite = (Exception_Sub1.itemTypeList.method1941((class46.anInt672), (byte) -74, (class46.anInt812), (class46.anInt781), (~0xffffff | (class46.anInt809)), (class46.anInt678), Class348_Sub8.aToolkit6654, class154));
                                            } else if ((class46.anInt806) == -1) sprite = (class46.method443(Class348_Sub8.aToolkit6654, (byte) -57));
                                            else sprite = (Class299_Sub1_Sub2.method2263(Class348_Sub8.aToolkit6654, 0, (class46.anInt806)));
                                            if (sprite == null) {
                                                if (Class348_Sub42_Sub13.aBoolean9616) Class251.method1916(-9343, class46);
                                            } else {
                                        ...
                                        if (model != null) {
                                            ...
                                            Class348_Sub8.aToolkit6654.DA(i_64_, i_65_, i_62_, i_63_);
                                            Class348_Sub8.aToolkit6654.ya();
                                            if (class46.aBoolean754) Class348_Sub8.aToolkit6654.C(false);
                                            if (class46.aBoolean784) {
                                            ...
                                            class46.method437(-20154, model, Class348_Sub8.aToolkit6654, Class367_Sub11.anInt7396, Class50_Sub1.aMatrix_5209);
                                            ...
                                            if (Class318_Sub1_Sub3_Sub2.aBoolean10046) Class348_Sub8.aToolkit6654.KA(i, i_12_, i_14_, i_17_);
                                            if (class46.aBoolean754) Class348_Sub8.aToolkit6654.C(true);
                                        }
                                        if (Class59_Sub1.aBoolean5300) {
                                            if (bool) Class338.method2663(-5590, i_19_, i_21_, i_20_, i_22_);
                                            else Class54.method503(i_22_, i_19_, (byte) -74, i_21_, i_20_);
                                        ...
                                        if (class46.anInt690 != 1) Class348_Sub8.aToolkit6654.method3688(i_69_, i_68_, i_70_, i_71_, class46.anInt749, class46.anInt690, 0);
                                        else Class348_Sub8.aToolkit6654.method3709(i_69_, i_68_, i_70_, i_71_, class46.anInt749, 0);
                                        if (Class59_Sub1.aBoolean5300) {
                                            if (bool) Class338.method2663(-5590, i_19_, i_21_, i_20_, i_22_);
                                            else Class54.method503(i_22_, i_19_, (byte) -74, i_21_, i_20_);
                                        }

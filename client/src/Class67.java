...
final class Class67 implements Interface1 {
    ...
    public final void method9(byte i, boolean bool) {
        if (bool) {
            ...
            int i_1_ = ((aClass158_4646.aClass341_4945.method2679(OpenGLToolkit.anInt7666, aClass158_4646.anInt4936, i + 1644)) + aClass158_4646.anInt4932);
    ...
    public final boolean method8(byte i) {
        anInt4644++;
        boolean bool = true;
        if (!aIndex_4650.fileReady(false, aClass158_4646.anInt4944)) bool = false;
        if (!aIndex_4651.fileReady(false, aClass158_4646.anInt4944)) bool = false;
        int i_2_ = -53 % ((i - 25) / 52);
        return bool;
    }
    ...
    public final void method7(int i) {
        anInt4647++;
        FontMetrics fontMetrics = Option_Sub10.getFontMetrics((byte) -45, aClass158_4646.anInt4944, aIndex_4651);
        if (i == 10286) aFontRenderer_4649 = (Class348_Sub8.active.method3686(fontMetrics, IndexedImage.method1523(aIndex_4650, aClass158_4646.anInt4944), true));
    }

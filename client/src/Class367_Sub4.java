...
final class Class367_Sub4 extends Class367 {
    ...
    static final boolean method3542(int i, Class357[][][] class357s, int i_13_, int i_14_, int i_15_, boolean bool) {
        ...
        if (((AnimBase.tileFlags[QuickChatPhraseTypeList.anInt4372][i_13_][i]) & 0x4) == 0) return false;
        int i_17_ = i_14_;
        int i_18_ = 0;
        ...
        while (i_17_ != i_18_) {
            ...
            if ((0x4 & (AnimBase.tileFlags[QuickChatPhraseTypeList.anInt4372][i_19_][i_22_])) == 0) bool_24_ = true;
            boolean bool_25_ = false;
            if (class357s != null) {
                int i_26_ = QuickChatPhraseTypeList.anInt4372 + 1;
                while_223_:
                for (/**/; i_26_ <= 3; i_26_++) {
                    if (class357s[i_26_] != null && (0x8 & (AnimBase.tileFlags[i_26_][i_19_][i_22_])) == 0) {
            ...
            if (!bool_24_) {
                ...
                if (++i_22_ < TextureOpBinary.mapWidth) {
                    ...
                    if (1 + i_19_ < mapLength && ((Class289.aByteArrayArrayArray3700[QuickChatPhraseTypeList.anInt4372][i_19_ + 1][i_22_]) != i_16_) && (0x4 & (AnimBase.tileFlags[QuickChatPhraseTypeList.anInt4372][i_19_][i_22_])) == 0 && (0x4 & (AnimBase.tileFlags[QuickChatPhraseTypeList.anInt4372][1 + i_19_][i_22_ + -1])) == 0) {
                ...
                if (--i_22_ >= 0) {
                    if (i_19_ + -1 >= 0 && i_16_ != (Class289.aByteArrayArrayArray3700[QuickChatPhraseTypeList.anInt4372][i_19_ - 1][i_22_]) && (0x4 & (AnimBase.tileFlags[QuickChatPhraseTypeList.anInt4372][i_19_][i_22_])) == 0 && (0x4 & (AnimBase.tileFlags[QuickChatPhraseTypeList.anInt4372][-1 + i_19_][1 + i_22_])) == 0) {
                    ...
                    if (mapLength > 1 + i_19_ && (Class289.aByteArrayArrayArray3700[QuickChatPhraseTypeList.anInt4372][1 + i_19_][i_22_]) != i_16_ && ((AnimBase.tileFlags[QuickChatPhraseTypeList.anInt4372][i_19_][i_22_]) & 0x4) == 0 && ((AnimBase.tileFlags[QuickChatPhraseTypeList.anInt4372][i_19_ + 1][i_22_ + 1]) & 0x4) == 0) {

...
final class TextureOpMonorchromeEdgeDetector extends TextureOp {
    ...
    static FontRenderer aFontRenderer_9173;

    public static void method3071(byte i) {
        if (i != 59) anApplet_Sub1_9169 = null;
        aClass60_9171 = null;
        aFontRenderer_9173 = null;
    }

    public TextureOpMonorchromeEdgeDetector() {
        super(1, true);
    }
    ...
    final void decode(Packet packet, int i, int i_2_) {
        if (i_2_ != 31015) monochromeOutput(-111, 25);
        anInt9170++;
    ...
    final int[] monochromeOutput(int i, int i_5_) {
        ...
        if (this.monochromeCache.dirty) {
            ...
            int[] is_8_ = this.monochromeOutput(i - -1 & Class299_Sub2.heightMask, 633706337, 0);
            for (int i_9_ = 0; TextureOpPolarDistortion.width > i_9_; i_9_++) {
                int i_10_ = anInt9167 * (-is_6_[i_9_] + is_8_[i_9_]);
                int i_11_ = (anInt9167 * (-is_7_[Option_Sub22.widthMask & -1 + i_9_] + is_7_[Option_Sub22.widthMask & i_9_ - -1]));
                int i_12_ = i_11_ >> 12;
                int i_13_ = i_10_ >> 12;

...
final class Class348_Sub42_Sub18 extends Class348_Sub42 {
    ...
    static final void method3273(boolean bool, int i, Class348_Sub16_Sub3 class348_sub16_sub3) {
        ...
        anInt9681++;
        if (bool) Class318_Sub7.method2510(Class129.SOUND_EFFECTS, class348_sub16_sub3, Option_Sub4.MIDI_INSTRUMENTS, false, Class348_Sub40.aClass279_7042, Class123.aIndex_1815);
    }
    ...
    static final void method3275(int i, int i_0_, int i_1_) {
        ...
        if (Class348_Sub42_Sub8_Sub2.modeGame != Class14_Sub4.aClass230_8638) {

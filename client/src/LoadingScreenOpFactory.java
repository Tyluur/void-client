...
final class LoadingScreenOpFactory {
    ...
    final Interface1 method1000(boolean bool, Interface12 interface12) {
        ...
        if (class223 == LightTypeList.aClass223_2489) return new Class5_Sub1(aIndex_1637, aIndex_1641, (Class369_Sub3) interface12);
        ...
        if (QuestTypeList.aClass223_2507 == class223) return new Class5_Sub1_Sub1(aIndex_1637, aIndex_1641, (Class369_Sub3_Sub1) interface12);
        return null;
    }
    ...
    // Class106
    LoadingScreenOpFactory(Index index, Index index_0_) {
        try {
            aIndex_1637 = index;

...
final class Class285_Sub1 extends Class285 implements Interface5_Impl1 {
    ...
    static final void method2129(byte i) {
        anInt8494++;
        Class21.aToolkit326.setCamera(r.aMatrix_9720);
        if (i < 9) anInt8492 = -40;
        Class21.aToolkit326.DA(Class248.anInt3202, Option_Sub5.anInt5886, Class14_Sub3.anInt8630, Class27.anInt394);
    }
    ...
    static final void method2131(int i) {
        if (i == 0) {
            if (Npc.anInt10503 == 2) {
                TextureOpColourEdgeDetector.aClass293Array9432[0].method2206(GfxTypeList.aClass315Array3982[0]);
                TextureOpColourEdgeDetector.aClass293Array9432[1].method2206(GfxTypeList.aClass315Array3982[1]);
            } else if (Npc.anInt10503 == 3) {
                TextureOpColourEdgeDetector.aClass293Array9432[0].method2206(GfxTypeList.aClass315Array3982[0]);
                TextureOpColourEdgeDetector.aClass293Array9432[1].method2206(GfxTypeList.aClass315Array3982[1]);
                TextureOpColourEdgeDetector.aClass293Array9432[2].method2206(GfxTypeList.aClass315Array3982[2]);
            } else {
                TextureOpColourEdgeDetector.aClass293Array9432[0].method2206(GfxTypeList.aClass315Array3982[0]);
                TextureOpColourEdgeDetector.aClass293Array9432[1].method2206(GfxTypeList.aClass315Array3982[1]);
                TextureOpColourEdgeDetector.aClass293Array9432[2].method2206(GfxTypeList.aClass315Array3982[2]);
                TextureOpColourEdgeDetector.aClass293Array9432[3].method2206(GfxTypeList.aClass315Array3982[3]);
            }
        } else if (i == 1) {
            if (Npc.anInt10503 == 2) TextureOpColourEdgeDetector.aClass293Array9432[0].method2206(GfxTypeList.aClass315Array3982[2]);
            else if (Npc.anInt10503 == 3) {
                TextureOpColourEdgeDetector.aClass293Array9432[0].method2206(GfxTypeList.aClass315Array3982[3]);
                TextureOpColourEdgeDetector.aClass293Array9432[1].method2206(GfxTypeList.aClass315Array3982[4]);
            } else {
                TextureOpColourEdgeDetector.aClass293Array9432[0].method2206(GfxTypeList.aClass315Array3982[4]);
                TextureOpColourEdgeDetector.aClass293Array9432[1].method2206(GfxTypeList.aClass315Array3982[5]);
                TextureOpColourEdgeDetector.aClass293Array9432[2].method2206(GfxTypeList.aClass315Array3982[6]);
            }
        } else if (i == 2) {
            if (Npc.anInt10503 == 2) TextureOpColourEdgeDetector.aClass293Array9432[0].method2206(GfxTypeList.aClass315Array3982[3]);
            else if (Npc.anInt10503 == 3) TextureOpColourEdgeDetector.aClass293Array9432[0].method2206(GfxTypeList.aClass315Array3982[5]);
            else TextureOpColourEdgeDetector.aClass293Array9432[0].method2206(GfxTypeList.aClass315Array3982[7]);
        }
    }
}

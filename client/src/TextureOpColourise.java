...
final class TextureOpColourise extends TextureOp {
    ...
    final int[][] colourOutput(int i, int i_3_) {
        ...
        anInt9353++;
        int[][] is = this.colourCache.get(i_3_ + 1564598957, i);
        if (this.colourCache.dirty) {
            int[][] is_4_ = this.outputColour((byte) -60, i, 0);
            int[] is_5_ = is_4_[0];
            int[] is_6_ = is_4_[1];
            int[] is_7_ = is_4_[2];
            int[] is_8_ = is[0];
    ...
    static final void method3120(int i) {
        ...
        TextureOpBricks.method3111(111, i_15_);
        int i_18_ = (-Class299.aClass348_Sub49_Sub2_3813.pos + TextureOpMandelbrot.anInt9341) / 16;
        ...
        ModelParticleEmitter.aByteArrayArray1887 = new byte[i_18_][];

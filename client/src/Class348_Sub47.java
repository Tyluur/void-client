...
final class Class348_Sub47 extends Node {
    ...
    static final boolean method3325(int i, int i_2_, boolean bool) {
        ...
        anInt7121++;
        return (((0x2000 & i) != 0 | Class156.method1241(i_2_, i, -118) | Option_Sub1.method1722(i, i_2_, (byte) 94)) & aa_Sub3.method166((byte) 105, i_2_, i));
    }

    final void method3326(byte i) {
        anInt7117++;
        if (Class176.aClass348_Sub47Array2334.length > Option_Sub13.anInt5980 && i == -45) Class176.aClass348_Sub47Array2334[Option_Sub13.anInt5980++] = this;
    }

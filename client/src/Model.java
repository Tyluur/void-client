...
abstract class Model {
    ...
    static final void method606(int i, boolean bool, String string) {
        ...
        int i_54_ = ((!bool ? Option_Sub6.quickChatPhraseTypeList.anInt4365 : Option_Sub6.quickChatPhraseTypeList.anInt4364) + i_53_);
        for (int i_55_ = i_53_; i_55_ < i_54_; i_55_++) {
            Class348_Sub42_Sub10 class348_sub42_sub10 = Option_Sub6.quickChatPhraseTypeList.method3471(i_55_, (byte) -102);
        ...
        for (int i_58_ = 0; Class76.anInt1285 > i_58_; i_58_++)
            strings[i_58_] = Option_Sub6.quickChatPhraseTypeList.method3471(is[i_58_], (byte) -91).method3219(Class348_Sub21.method2955(i, 81));

...
final class Class5_Sub2 extends Class5 {
    ...
    final void method178(int i, boolean bool, byte i_16_, int i_17_) {
        Class348_Sub8.active.method3628(-2 + i, i_17_, 4 + this.aClass369_4635.anInt4971, 2 + this.aClass369_4635.anInt4963, (((Class369_Sub2) this.aClass369_4635).anInt8585), 0);
        anInt8360++;
        Class348_Sub8.active.method3628(i - 1, 1 + i_17_, this.aClass369_4635.anInt4971 - -2, this.aClass369_4635.anInt4963, 0, 0);
    ...
    final void method182(int i, int i_18_, int i_19_, boolean bool) {
        ...
        Class348_Sub8.active.aa(i_19_, 2 + i_18_, i_21_, (this.aClass369_4635.anInt4963) - 2, ((Class369_Sub2) this.aClass369_4635).anInt8591, 0);
        Class348_Sub8.active.aa(i_21_ + i_19_, 2 + i_18_, this.aClass369_4635.anInt4971 - i_21_, this.aClass369_4635.anInt4963 - 2, 0, 0);
    }

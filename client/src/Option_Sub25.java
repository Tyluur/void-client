...
final class Option_Sub25 extends Option {
    ...
    final int method1714(int i, int i_0_) {
        ...
        if (!this.aClientOptions_3136.method3428((byte) -89).method1460(-38)) return 3;
    ...
    // method1827
    static final void initHSVToRGB(int i) {
        anInt6112++;
        if (Class126.HSV_TO_RGB == null) Class126.HSV_TO_RGB = new int[65536];
        else return;
        ...
        for (int i_6_ = 0; i_6_ < 512; i_6_++) {
            ...
            for (int i_8_ = 0; i_8_ < 128; i_8_++) {
                ...
                Class126.HSV_TO_RGB[i_5_++] = i_23_;
            }
        }
    }
    ...
    final int method1710(int i) {
        ...
        if (!this.aClientOptions_3136.method3428((byte) -113).method1460(i + -20083)) return 0;
        return 2;
    }

    Option_Sub25(int i, ClientOptions clientOptions) {
        super(i, clientOptions);
    }

    Option_Sub25(ClientOptions clientOptions) {
        super(clientOptions);
    }
    ...
    final void method1716(boolean bool) {
        anInt6108++;
        if (!this.aClientOptions_3136.method3428((byte) -106).method1460(-33)) this.anInt3138 = 0;
    ...
    final boolean method1831(int i) {
        anInt6105++;
        if (i < 85) return true;
        return this.aClientOptions_3136.method3428((byte) -124).method1460(-59);
    }

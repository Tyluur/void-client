...
final class Class55_Sub1 extends Class55 {
    ...
    private final Index aIndex_5267;
    ...
    final void method522(byte i) {
        ...
        if (anIntArray5269 != null && i < -27) {
            for (int i_0_ = 0; i_0_ < 10 && anIntArray5269.length > anInt5270 + i_0_; i_0_++) {
                if (aByteArrayArray5275[i_0_] == null && aIndex_5267.requestDownload(-10499, (anIntArray5269[i_0_ + anInt5270]), 0)) aByteArrayArray5275[i_0_] = aIndex_5267.file(-1860, (anIntArray5269[anInt5270 + i_0_]), 0);
            }
        }
    }
    ...
    final int method516(byte i, byte[] is) throws IOException {
        ...
        if (anIntArray5269 == null) {
            ...
            byte[] is_4_ = aIndex_5267.file(-1860, anInt5272, 0);

            ...
            synchronized (this) {
                try {
                    ...
                    if (anLoadingScreen_3907 instanceof Class294) anLoadingScreen_3907.method58(aBoolean3908, -104);
                        ...
                        if (Class348_Sub8.active != null && anLoadingScreen_3919 != null && anLoadingScreen_3919.method55((byte) -58) != 0 && (aLong3914 >= l_1_ - (long) anLoadingScreen_3919.method55((byte) -58))) {
                            ...
                            Sprite sprite = (Class348_Sub8.active.method3629(Class321.anInt4017, Class348_Sub42_Sub8_Sub2.anInt10432, true));
                            Class348_Sub8.active.method3681(sprite, 0);
                            anLoadingScreen_3919.method58(true, -126);
                            Class348_Sub8.active.method3672();
                            ...
                            if (aBoolean3908) {
                                ...
                                if (Class348_Sub8.active != null) Class348_Sub8.active.GA(0);
                            }
                            anLoadingScreen_3907.method58((aBoolean3908 || (Class348_Sub8.active != null && Class348_Sub8.active.method3655())), -90);
                        }
                        try {
                            if (Class348_Sub8.active != null && !(anLoadingScreen_3907 instanceof Class294)) Class348_Sub8.active.method3689((byte) 57);
                    ...
                    else container = TextureOpMonorchromeEdgeDetector.anApplet_Sub1_9169;
                    container.getSize();
                    container.getSize();
                    if (Class52.aFrame4904 == container) Class52.aFrame4904.getInsets();
                    aBoolean3908 = false;
                    if (Class348_Sub8.active != null && !(anLoadingScreen_3907 instanceof Class294) && (aLoadState_3916.method525(-112) < LoadState.SHOW_LOGIN_WINDOW.method525(-127))) Class367_Sub11.method3556(false);

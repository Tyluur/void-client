...
final class TextureOpCurve extends TextureOp {
    ...
    private final void method3081(int i) {
        ...
        if (i_2_ == 2) {
            ...
            for (i_2_ = 0; i_2_ < 257; i_2_++) {
                ...
                int i_24_ = (-(Class127.COSINE[(i_23_ & 0x1ff6) >> 5]) + 4096 >> 1);
    ...
    final int[] monochromeOutput(int i, int i_33_) {
        anInt9207++;
        ...
        if (this.monochromeCache.dirty) {
            ...
            for (int i_35_ = 0; i_35_ < TextureOpPolarDistortion.width; i_35_++) {
    ...
    private final void method3082(byte i) {
        ...
        if (i != 73) monochromeOutput(75, 39);

...
final class Option_Sub17 extends Option {
    ...
    static final void method1797(int i, int i_11_, Class46 class46, byte i_12_) {
        ...
        String string = Option_Sub8.method1753(0, class46);
        if (string != null) {
        ...
        if (client.method105(class46).method3305(0)) {
            ...
            else Class50_Sub3.method466(false, "", class46.anInt830, (byte) -79, false, class46.anInt704, class46.anInt812, true, 16, class46.anInt704 << 0 | class46.anInt830, Class274.aClass274_3492.method2063(Class348_Sub33.language, 544), 0L, -1);
            Class348_Sub42_Sub15.anInt9655++;
        }
    }

    Option_Sub17(ClientOptions clientOptions) {
        super(clientOptions);
    }

    Option_Sub17(int i, ClientOptions clientOptions) {
    ...
    final int method1710(int i) {
        ...
        anInt6027++;
        if (this.aClientOptions_3136.method3428((byte) -96).method1462(-113) > 1) return 4;
        return 2;
    }
}

...
final class TextureOpTexture extends TextureOp {
    ...
    final void createImageCache(int width, int height, int i_11_) {
        super.createImageCache(width, height, i_11_);
        anInt9382++;
        if (anInt9380 >= 0 && Class286_Sub5.textureSource != null) {
            int i_12_ = (!(Class286_Sub5.textureSource.getMetrics(anInt9380, -6662).aBoolean199) ? 128 : 64);
            anIntArray9375 = Class286_Sub5.textureSource.rgbPixels(false, anInt9380, 1.0F, i_12_, i_12_, -123);
            anInt9379 = i_12_;
            anInt9374 = i_12_;
        }
    }
    ...
    final void decode(Packet packet, int i, int i_15_) {
        if (i_15_ == 31015) {

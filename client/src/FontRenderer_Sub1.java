...
final class FontRenderer_Sub1 extends FontRenderer {
    ...
    final void fa(char c, int i, int i_0_, int i_1_, boolean bool) {
        ...
        if (i_2_ > 0 && i_3_ > 0) {
            if ((i_1_ & ~0xffffff) == -16777216) method2588(aByteArrayArray6490[c], aJavaToolkit_6486.surfaceRaster, i_1_, i_8_, i_5_, i_2_, i_3_, i_6_, i_7_);
            else if ((i_1_ & ~0xffffff) != 0) method2586(aByteArrayArray6490[c], aJavaToolkit_6486.surfaceRaster, i_1_, i_8_, i_5_, i_2_, i_3_, i_6_, i_7_);
        }
    }
    ...
    final void method2578(char c, int i, int i_60_, int i_61_, boolean bool, aa var_aa, int i_62_, int i_63_) {
        if (var_aa == null) fa(c, i, i_60_, i_61_, bool);
            ...
            if (i_64_ > 0 && i_65_ > 0) {
                if ((i_61_ & ~0xffffff) == -16777216) method2587(aByteArrayArray6490[c], aJavaToolkit_6486.surfaceRaster, i_61_, i_70_, i_67_, i_64_, i_65_, i_68_, i_69_, i, i_60_, anIntArray6489[c], var_aa, i_62_, i_63_);
                else method2589(aByteArrayArray6490[c], aJavaToolkit_6486.surfaceRaster, i_61_, i_70_, i_67_, i_64_, i_65_, i_68_, i_69_, i, i_60_, anIntArray6489[c], var_aa, i_62_, i_63_);
            }
        }
    }
    ...
    FontRenderer_Sub1(JavaToolkit var_javaToolkit, FontMetrics fontMetrics, IndexedImage[] indexedImages, int[] is, int[] is_103_) {
        super(var_javaToolkit, fontMetrics);
        aJavaToolkit_6486 = var_javaToolkit;
        anIntArray6489 = is;
        anIntArray6488 = is_103_;
        aByteArrayArray6490 = new byte[indexedImages.length][];
        anIntArray6487 = new int[indexedImages.length];
        anIntArray6491 = new int[indexedImages.length];
        for (int i = 0; i < indexedImages.length; i++) {
            aByteArrayArray6490[i] = indexedImages[i].raster;
            anIntArray6487[i] = indexedImages[i].offsetY;
            anIntArray6491[i] = indexedImages[i].offsetX;
        }
    }
}

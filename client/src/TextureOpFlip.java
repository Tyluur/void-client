...
final class TextureOpFlip extends TextureOp {
    ...
    final int[][] colourOutput(int i, int i_0_) {
        ...
        if (this.colourCache.dirty) {
            ...
            int[] is_7_ = is[2];
            if (aBoolean9140) {
                for (int i_8_ = 0; i_8_ < TextureOpPolarDistortion.anInt9139; i_8_++) {
                        ...
                        if (!client.method111(class46)) {
                            ...
                            if (class46 == Class289.aClass46_3701) {
                                ...
                                if (Class300.aBoolean3819 && Class127_Sub1.aBoolean8386) {
                                    ...
                                    if (class46.anInt709 + i_29_ > ((Class331.aClass46_4130.anInt709) + TextureOpBoxBlur.anInt9461)) i_29_ = (-class46.anInt709 + ((TextureOpBoxBlur.anInt9461) + (Class331.aClass46_4130.anInt709)));
                            ...
                            if (i_31_ < i_34_ && i_32_ < i_33_) {
                                if (class46.anInt765 != 0) {
                                    ...
                                    if (class46.anInt765 == SafeModeOption.anInt5951) {
                                        if (class46.method425((Class348_Sub8.active), (byte) 26) != null) {
                                    ...
                                    if (Class218.anInt2861 == class46.anInt765) {
                                        Class361.method3498(class46.anInt789, Class348_Sub8.active, i_24_, class46.anInt709, true, i_25_);
                                        Class152.aBooleanArray2076[i_23_] = true;
                                        Class348_Sub8.active.KA(i, i_12_, i_14_, i_17_);
                                        continue;
                                    }
                                    if (Class136.anInt4793 == class46.anInt765) {
                                        if (Class298.aBoolean3811 || Class188.aBoolean2514) {
                                            ...
                                            if (Class298.aBoolean3811) {
                                                ...
                                                i_38_ += 15;
                                                int i_43_ = (Class348_Sub8.active.E() / 1024);
                                            ...
                                            if (Class188.aBoolean2514) {
                                                Class240.aFontRenderer_4684.method2569(("Polys: " + Class348_Sub8.active.I() + " Models: " + Class348_Sub8.active.M()), i_38_, -256, i_37_, -127, -1);
                                                i_38_ += 12;
                                ...
                                if (Class175.aBooleanArray2326[i_23_] || NativeToolkit.anInt8045 > 1) {
                                    if (class46.anInt774 == 3) {
                                        if (i_28_ == 0) {
                                            if (class46.aBoolean810) Class348_Sub8.active.aa(i_24_, i_25_, (class46.anInt709), (class46.anInt789), (class46.anInt749), 0);
                                            else Class348_Sub8.active.method3628(i_24_, i_25_, (class46.anInt709), (class46.anInt789), (class46.anInt749), 0);
                                        } else if (!class46.aBoolean810) Class348_Sub8.active.method3628(i_24_, i_25_, class46.anInt709, class46.anInt789, (0xffffff & class46.anInt749 | (-(i_28_ & 0xff) + 255 << 24)), 1);
                                        else Class348_Sub8.active.aa(i_24_, i_25_, class46.anInt709, class46.anInt789, (0xffffff & class46.anInt749 | (-(0xff & i_28_) + 255 << 24)), 1);
                                        if (Class59_Sub1.aBoolean5300) {
                                            if (bool) Class338.method2663(-5590, i_19_, i_21_, i_20_, i_22_);
                                            else Class54.method503(i_22_, i_19_, (byte) -74, i_21_, i_20_);
                                        }
                                    } else if (class46.anInt774 == 4) {
                                        FontRenderer fontRenderer = class46.method426((Class348_Sub8.active), (byte) 68);
                                        if (fontRenderer == null) {
                                            ...
                                            if (class46.anInt812 != -1) {
                                                ItemDefinition itemDefinition = (Exception_Sub1.itemTypeList.method1940(-67, (class46.anInt812)));
                                            ...
                                            if (Class318_Sub1_Sub3_Sub2.aBoolean10046) Class348_Sub8.active.T(i_24_, i_25_, (class46.anInt709) + i_24_, (class46.anInt789) + i_25_);
                                            ...
                                            if (Class318_Sub1_Sub3_Sub2.aBoolean10046) Class348_Sub8.active.KA(i, i_12_, i_14_, i_17_);
                                            if (string.trim().length() > 0) {
                                                if (Class318_Sub1_Sub3_Sub2.aBoolean10046) {
                                                    ...
                                                    FontMetrics fontMetrics = (Class135.method1151(-25411, (Class348_Sub8.active), (class46.anInt702)));
                                        ...
                                        if (class46.anInt705 >= 0)
                                            class46.method444(bool_15_, Class123.skyBoxSphereTypeList, Class30.skyBoxTypeList).method2293(0, Class348_Sub8.active, (byte) -35, i_24_, class46.anInt709, i_25_, (class46.anInt835 << 3), (class46.anInt759 << 3), 0, class46.anInt789);
                                        else {
                                            Sprite sprite;
                                            if (class46.anInt812 != -1) {
                                                Class154 class154 = ((class46.aBoolean720) ? (Class132.aPlayer_1907.aClass154_10536) : null);
                                                sprite = (Exception_Sub1.itemTypeList.method1941((class46.anInt672), (byte) -74, (class46.anInt812), (class46.anInt781), (~0xffffff | (class46.anInt809)), (class46.anInt678), Class348_Sub8.active, class154));
                                            } else if ((class46.anInt806) == -1) sprite = (class46.method443(Class348_Sub8.active, (byte) -57));
                                            else sprite = (Class299_Sub1_Sub2.method2263(Class348_Sub8.active, 0, (class46.anInt806)));
                                            if (sprite == null) {
                                                if (Class348_Sub42_Sub13.aBoolean9616) Class251.method1916(-9343, class46);
                                            } else {
                                                ...
                                                if (class46.aBoolean697) {
                                                    Class348_Sub8.active.T(i_24_, i_25_, i_24_ - -(class46.anInt709), (class46.anInt789) + i_25_);
                                        ...
                                        TextureUniverse.method3489(115);
                                        Model model = null;
                                        int i_60_ = 0;
                                        if (class46.anInt812 != -1) {
                                            ...
                                            if (itemDefinition != null) {
                                                ...
                                                model = (itemDefinition.method1559(class154, animationType, Class348_Sub8.active, 2048, (class46.anInt841), 1, (class46.anInt795), (byte) 88, (class46.anInt730)));
                                            ...
                                            if (i_61_ >= 0 && (i_61_ < 2048)) {
                                                ...
                                                if ((player != null) && ((i_61_ == (Class348_Sub42_Sub11.index)) || ((class46.anInt779) == (Class318_Sub1_Sub3_Sub1.method2418((player.aString10544), (byte) -50)))))
                                                    model = (player.aClass154_10536.method1226((Class318_Sub1_Sub3_Sub3.timedVarDomain), null, null, true, (Exception_Sub1.itemTypeList), 0, animationType, class46.anInt730, true, -1, null, 2048, (TextureOpMandelbrot.idkTypeList), class46.anInt841, (Class348_Sub8.active), (BillboardType.npcTypeList), (Class10.animTypeList), 0, class46.anInt795, 0, (Class64_Sub3.basTypeList)));
                                            }
                                            ...
                                            if (class348_sub13 != null) {
                                                Class154 class154 = ((class46.aBoolean720) ? (Class132.aPlayer_1907.aClass154_10536) : null);
                                                model = (class348_sub13.method2803(animationType, class154, (class46.anInt779), (class46.anInt795), (class46.anInt841), (class46.anInt730), 2048, Class348_Sub8.active, (class46.anInt770) == 9, -1));
                                            }
                                        } else if (class46.anInt699 == -1) {
                                            model = (class46.method430((TextureOpMandelbrot.idkTypeList), Class10.animTypeList, 2048, Class348_Sub8.active, -1, 0, (Exception_Sub1.itemTypeList), (Class318_Sub1_Sub3_Sub3.timedVarDomain), 255, (Class132.aPlayer_1907.aClass154_10536), null, (Class64_Sub3.basTypeList), (BillboardType.npcTypeList), -1));
                                        ...
                                        if (model != null) {
                                            ...
                                            Class157.aMatrix_2123.method910();
                                            Class348_Sub8.active.setCamera(Class157.aMatrix_2123);
                                            Class348_Sub8.active.DA(i_64_, i_65_, i_62_, i_63_);
                                            Class348_Sub8.active.ya();
                                            if (class46.aBoolean754) Class348_Sub8.active.C(false);
                                            if (class46.aBoolean784) {
                                                Class50_Sub1.aMatrix_5209.method899(class46.anInt757);
                                                Class50_Sub1.aMatrix_5209.method896(class46.anInt675);
                                                Class50_Sub1.aMatrix_5209.method908(class46.anInt717);
                                                Class50_Sub1.aMatrix_5209.translate((class46.anInt688), (class46.anInt799), (class46.anInt787));
                                            } else {
                                                int i_66_ = ((((class46.anInt716) << 2) * (Class70.SIN[(class46.anInt757 << 3)])) >> 14);
                                                int i_67_ = (((Class70.COS[((class46.anInt757) << 3)]) * ((class46.anInt716) << 2)) >> 14);
                                                Class50_Sub1.aMatrix_5209.method902(-(class46.anInt717) << 3);
                                                Class50_Sub1.aMatrix_5209.method896((class46.anInt675) << 3);
                                                Class50_Sub1.aMatrix_5209.translate(((class46.anInt808) << 2), (((class46.anInt786) << 2) + (i_66_ + i_60_)), ((class46.anInt786) << 2) + i_67_);
                                                Class50_Sub1.aMatrix_5209.method900((class46.anInt757) << 3);
                                            }
                                            class46.method437(-20154, model, Class348_Sub8.active, Class367_Sub11.anInt7396, Class50_Sub1.aMatrix_5209);
                                            if (Class318_Sub1_Sub3_Sub2.aBoolean10046) Class348_Sub8.active.T(i_24_, i_25_, (class46.anInt709) + i_24_, (i_25_ + (class46.anInt789)));
                                            if (!class46.aBoolean784) {
                                                if (!class46.aBoolean689) {
                                                    model.render((Class50_Sub1.aMatrix_5209), null, 1);
                                                    if ((class46.aClass318_Sub10_740) != null) Class348_Sub8.active.method3684(class46.aClass318_Sub10_740.method2539());
                                            ...
                                            if (Class318_Sub1_Sub3_Sub2.aBoolean10046) Class348_Sub8.active.KA(i, i_12_, i_14_, i_17_);
                                            if (class46.aBoolean754) Class348_Sub8.active.C(true);
                                        }
                                        if (Class59_Sub1.aBoolean5300) {
                                            if (bool) Class338.method2663(-5590, i_19_, i_21_, i_20_, i_22_);
                                            else Class54.method503(i_22_, i_19_, (byte) -74, i_21_, i_20_);
                                        ...
                                        if (class46.anInt690 != 1) Class348_Sub8.active.method3688(i_69_, i_68_, i_70_, i_71_, class46.anInt749, class46.anInt690, 0);
                                        else Class348_Sub8.active.method3709(i_69_, i_68_, i_70_, i_71_, class46.anInt749, 0);
                                        if (Class59_Sub1.aBoolean5300) {
                                            if (bool) Class338.method2663(-5590, i_19_, i_21_, i_20_, i_22_);
                                            else Class54.method503(i_22_, i_19_, (byte) -74, i_21_, i_20_);
                                        }
    ...
    static final void method3065(int i, boolean bool, int i_74_) {
        ...
        Class348_Sub47 class348_sub47 = Class286_Sub3.method2148(TextureOpBrightness.aClass351_9089, Class348_Sub23_Sub2.aClass77_9029, -97);
    ...
    final int[] monochromeOutput(int i, int i_75_) {
        anInt9143++;
        ...
        if (this.monochromeCache.dirty) {
            ...
            if (aBoolean9140) {
                for (int i_77_ = 0; (i_77_ < TextureOpPolarDistortion.anInt9139); i_77_++)
                    is[i_77_] = is_76_[Option_Sub22.anInt6076 + -i_77_];
            } else Class214.method1578(is_76_, 0, is, 0, TextureOpPolarDistortion.anInt9139);
        }
        return is;
    }

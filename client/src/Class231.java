...
final class Class231 {
    ...
    static final void method1642(byte i, Toolkit var_toolkit) {
        anInt2997++;
        int i_3_ = 0;
        int i_4_ = 0;
        ...
        if (i > 98) {
            Class262.aFontRenderer_3326.method2576(Class274.aClass274_3507.method2063(Class348_Sub33.language, 544), i_5_, i_4_ + (Class348_Sub42_Sub5.anInt9532 - -14), i_3_ + (Class135_Sub1.anInt4717 + 3), -1, -125);

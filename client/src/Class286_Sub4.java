...
final class Class286_Sub4 extends Class286 {
    ...
    static final String method2157(int i, int i_15_) {
        ...
        VideoType videoType = ((VideoType) Class27.aHashTable_389.get(i, -6008));
        if (videoType != null) {
            Class348_Sub23_Sub4 class348_sub23_sub4 = videoType.aClass55_Sub1_6768.method513(i_15_ + 1431655815);
            if (class348_sub23_sub4 != null) {
                double d = videoType.aClass55_Sub1_6768.method519(i_15_ ^ 0x55555524);

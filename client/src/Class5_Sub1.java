...
class Class5_Sub1 extends Class5 {
    ...
    static final int[] method184(int i) {
        ...
        return (new int[]{LoadState.anInt1044, AnimationType.anInt235, Class291.anInt3736});
    }
    ...
    final void method178(int i, boolean bool, byte i_27_, int i_28_) {
        if (bool) {
            int[] is = new int[4];
            Class348_Sub8.active.K(is);
            Class348_Sub8.active.KA(i, i_28_, i - -this.aClass369_4635.anInt4971, (i_28_ + this.aClass369_4635.anInt4963));
            int i_29_ = aSprite_8342.scaleWidth();
            int i_30_ = aSprite_8342.scaleHeight();
            int i_31_ = aSprite_8339.scaleWidth();
            int i_32_ = aSprite_8339.scaleHeight();
            ...
            Class348_Sub8.active.KA(i, i_28_, (this.aClass369_4635.anInt4971 + i), i_28_ - -aSprite_8343.scaleHeight());
            aSprite_8343.method972(i + i_29_, i_28_, -i_29_ + (this.aClass369_4635.anInt4971) - i_31_, this.aClass369_4635.anInt4963);
            int i_33_ = aSprite_8338.scaleHeight();
            Class348_Sub8.active.KA(i, (-i_33_ + i_28_ - -this.aClass369_4635.anInt4963), this.aClass369_4635.anInt4971 + i, (i_28_ + this.aClass369_4635.anInt4963));
            ...
            Class348_Sub8.active.KA(is[0], is[1], is[2], is[3]);
        }
        anInt8334++;
    ...
    final void method182(int i, int i_35_, int i_36_, boolean bool) {
        ...
        int i_40_ = i_35_ - -aSprite_8343.scaleHeight();
        int i_41_ = (i_35_ + this.aClass369_4635.anInt4963 - aSprite_8338.scaleHeight());
        int i_42_ = -i_38_ + i_39_;
        int i_43_ = -i_40_ + i_41_;
        int i_44_ = this.method183(124) * i_42_ / 10000;
        int[] is = new int[4];
        Class348_Sub8.active.K(is);
        Class348_Sub8.active.KA(i_38_, i_40_, i_44_ + i_38_, i_41_);
        method186(i_40_, i_43_, (byte) 33, i_38_, i_42_);
        Class348_Sub8.active.KA(i_44_ + i_38_, i_40_, i_39_, i_41_);

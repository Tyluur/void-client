...
final class Option_Sub8 extends Option {
    ...
    static final int method1749(Class110_Sub1 class110_sub1, Class110_Sub1 class110_sub1_0_, boolean bool, int i, byte i_1_) {
        try {
            ...
            if (i == 2) return (Option_Sub21.method1811(9152, (class110_sub1_0_.method1038(false).aString3663), Class348_Sub33.language, (class110_sub1.method1038(false).aString3663)));
            if (i == 3) {
                ...
                return (Option_Sub21.method1811(9152, class110_sub1_0_.aString5787, Class348_Sub33.language, class110_sub1.aString5787));
            }
            if (i == 4) {
    ...
    final int method1710(int i) {
        ...
        anInt5914++;
        if (this.aClientOptions_3136.method3428((byte) -80).method1456((byte) 111)) return 3;
        return 2;
    }
    ...
    Option_Sub8(ClientOptions clientOptions) {
        super(clientOptions);
    }

    Option_Sub8(int i, ClientOptions clientOptions) {

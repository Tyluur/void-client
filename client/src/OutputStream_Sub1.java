        ...
        if (Class147.aClass357ArrayArrayArray2029 == null) Class348_Sub8.active.method3675(i_0_, (byte) -125, i_1_, i_3_, i_2_, -16777216);
            ...
            for (int i_13_ = 0; i_13_ < 5; i_13_++) {
                if (Class181.aBooleanArray2374[i_13_]) {
                    int i_14_ = (int) ((Math.random() * (double) ((Class275.anIntArray3552[i_13_] * 2) - -1)) - (double) Class275.anIntArray3552[i_13_] + (Math.sin((double) (Class318_Sub1_Sub1_Sub2.anIntArray9981[i_13_]) * ((double) (Class338.anIntArray4196[i_13_]) / 100.0)) * (double) (ItemTypeList.anIntArray3273[i_13_])));
                    if (i_13_ == 4) {
                        ClientScript.anInt9701 += i_14_;
                        if (ClientScript.anInt9701 >= 1024) {
                            if (ClientScript.anInt9701 > 3072) ClientScript.anInt9701 = 3072;
                        } else ClientScript.anInt9701 = 1024;
                    }
            ...
            if (Class59_Sub1.aBoolean5300) {
                ...
                if (VarcTypeList.aClass305_3304 != null) VarcTypeList.aClass305_3304.method2293(LightTypeList.anInt2481 << 3, Class348_Sub8.active, (byte) -72, i_1_, i_0_, i_3_, Class5.anInt4638, ClientScript.anInt9701, i_15_, i_2_);
                else Class348_Sub8.active.GA(i_15_);
            }
            ...
            if (i >= 80) {
                ...
                Class348_Sub8.active.DA(i_0_ / 2 + i_1_, i_3_ + i_2_ / 2, Class97.anInt1550 << 1, Class97.anInt1550 << 1);
                ...
                if (Class240.mainLogicStep == 10) {
                    ...
                    OpenGLToolkit.method3802(i_3_, i_2_, 2, i_1_, i_0_, 256, 256);
                    Class318_Sub1_Sub1_Sub2.method2403(i_1_, 256, i_3_, i_0_, 19206, i_2_, 256);
                    CursorTypeList.method1289(i_2_, i_0_, i_3_, 8, i_1_);
                }

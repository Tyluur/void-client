...
final class Deque {
    ...
    private final void method1989(Node node, boolean bool, Deque deque_1_) {
        do {
            try {
                anInt3325++;
                ...
                throw Class348_Sub17.method2929(runtimeexception, ("uh.K(" + (node != null ? "{...}" : "null") + ',' + bool + ',' + (deque_1_ != null ? "{...}" : "null") + ')'));
            }
            break;
        } while (false);
    }
    ...
    static final Toolkit method2000(int i, int i_23_, Canvas canvas, TextureSource var_d) {
        try {
            ...
            return new OpenGLToolkit(canvas, var_d, i_23_);
        } catch (RuntimeException runtimeexception) {

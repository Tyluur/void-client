...
final class Class318_Sub10 extends Class318 {
        ...
        for (Class318_Sub7 class318_sub7 = (Class318_Sub7) aClass243_6478.method1872(8); class318_sub7 != null; class318_sub7 = (Class318_Sub7) aClass243_6478.method1878((byte) -28)) {
            if (modelParticleEmitters != null) {
                for (int i = 0; i < modelParticleEmitters.length; i++) {
                    if ((class318_sub7.aModelParticleEmitter_6436 == modelParticleEmitters[i]) || (class318_sub7.aModelParticleEmitter_6436 == modelParticleEmitters[i].aModelParticleEmitter_1888)) {
    ...
    private final void method2538(ModelParticleEffector[] modelParticleEffectors, boolean bool) {
        for (int i = 0; i < 8; i++)
        ...
        if (modelParticleEffectors != null) {
            for (int i = 0; i < modelParticleEffectors.length; i++) {
                ...
                if (!aBooleanArray6477[i]) {
                    ...
                    if ((modelParticleEffectors[i].method2685((byte) -13).anInt2296) == 1 && Class318_Sub7.anInt6450 < 32) {
                        class348_sub42_sub20 = new Class348_Sub42_Sub20(modelParticleEffectors[i], this);
                        Class367_Sub11.aClass32_7415.method335(class348_sub42_sub20, -8098, modelParticleEffectors[i].anInt4245);
                        Class318_Sub7.anInt6450++;
                    }

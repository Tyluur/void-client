...
final class TextureOpPerlinNoise extends TextureOp {
    ...
    final int[] monochromeOutput(int i, int i_2_) {
        ...
        if (this.monochromeCache.dirty) method3069(i, is, (byte) 98);
        return is;
    }
    ...
    final void finish(int i) {
        aByteArray9152 = Toolkit.getPermutation(this.anInt9156, 95);
        anInt9148++;
        method3067((byte) -98);
    ...
    final void method3069(int i, int[] is, byte i_8_) {
        anInt9161++;
        int i_9_ = (Option_Sub18.normalisedY[i] * this.anInt9164);
        if (i_8_ > 91) {
            if (this.anInt9150 == 1) {
                ...
                if (this.aBoolean9160) {
                    for (int i_52_ = 0; (TextureOpPolarDistortion.width > i_52_); i_52_++) {
                        int i_53_ = (this.anInt9158 * Class318_Sub6.normalisedX[i_52_]);
                        int i_54_ = method3070(i_46_, i_41_, i_42_, i_53_ * i_39_ >> 12, i_47_, true, i_48_);
                        i_54_ = i_40_ * i_54_ >> 12;
                        is[i_52_] = (i_54_ >> 1) + 2048;
                    }
                } else {
                    for (int i_49_ = 0; i_49_ < TextureOpPolarDistortion.width; i_49_++) {
                        int i_50_ = (this.anInt9158 * Class318_Sub6.normalisedX[i_49_]);
                ...
                if (i_10_ > 8 || i_10_ < -8) {
                    ...
                    for (int i_20_ = 0; TextureOpPolarDistortion.width > i_20_; i_20_++) {
                        int i_21_ = (Class318_Sub6.normalisedX[i_20_] * this.anInt9158);
                ...
                for (int i_23_ = 1; this.anInt9150 > i_23_; i_23_++) {
                    ...
                    if (i_10_ > 8 || i_10_ < -8) {
                        ...
                        if (this.aBoolean9160 && (this.anInt9150 - 1 == i_23_)) {
                            for (int i_33_ = 0; TextureOpPolarDistortion.width > i_33_; i_33_++) {
                                int i_34_ = (Class318_Sub6.normalisedX[i_33_] * (this.anInt9158));
                                int i_35_ = method3070(i_32_, i_25_, i_26_, i_34_ * i_24_ >> 12, i_31_, true, i_30_);
                                i_35_ = is[i_33_] - -(i_35_ * i_10_ >> 12);
                                is[i_33_] = (i_35_ >> 1) + 2048;
                            }
                        } else {
                            for (int i_36_ = 0; (i_36_ < TextureOpPolarDistortion.width); i_36_++) {
                                int i_37_ = (this.anInt9158 * Class318_Sub6.normalisedX[i_36_]);

...
final class Class205 {
    ...
    static final void method1496(int i, int i_0_, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_) {
        ...
        if (i_0_ >= Class132.anInt1910 && i_0_ <= Class38.anInt513) {
            int[] is = AnimationType.anIntArrayArray255[i_0_];
        ...
        while (i_6_ < i_8_) {
            ...
            if (i_9_ >= 0) {
                ...
                if (Class132.anInt1910 <= i_19_ && Class38.anInt513 >= i_18_) {
                    if (i_8_ >= i_7_) {
                        ...
                        if (i_19_ <= Class38.anInt513) Class135_Sub2.method1156(-27, i_20_, (AnimationType.anIntArrayArray255[i_19_]), i_21_, i);
                        if (Class132.anInt1910 <= i_18_) Class135_Sub2.method1156(-27, i_20_, (AnimationType.anIntArrayArray255[i_18_]), i_21_, i);
                    } else {
                        ...
                        if (Class38.anInt513 >= i_19_) {
                            int[] is = AnimationType.anIntArrayArray255[i_19_];
            ...
            if (Class132.anInt1910 <= i_28_ && i_27_ <= Class38.anInt513) {
                ...
                if (Class369.anInt4960 <= i_29_ && i_30_ <= Class113.anInt1745) {
                    ...
                    if (i_6_ >= i_7_) {
                        if (Class38.anInt513 >= i_28_) Class135_Sub2.method1156(-27, i_29_, (AnimationType.anIntArrayArray255[i_28_]), i_30_, i);
                        if (i_27_ >= Class132.anInt1910) Class135_Sub2.method1156(-27, i_29_, (AnimationType.anIntArrayArray255[i_27_]), i_30_, i);
                    } else {
                        ...
                        if (i_28_ <= Class38.anInt513) {
                            int[] is = AnimationType.anIntArrayArray255[i_28_];
                        ...
                        if (Class132.anInt1910 <= i_27_) {
                            int[] is = AnimationType.anIntArrayArray255[i_27_];

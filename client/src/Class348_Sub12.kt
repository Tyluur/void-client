...
*/
class Class348_Sub12 internal constructor(var aClass348_Sub21_6751: Class348_Sub21?) : Class348() {
    var anInt6735: Int
    var anInt6737: Int
    ...
    companion object {
        ...
        private var aShortArrayArray6741: Array<ShortArray?>? = arrayOf<ShortArray?>(
            shortArrayOf(6798, 107, 10283, 16, 4797, 7744, 5799, 4634, -31839, 22433, 2983, -11343, 8, 5281, 10438, 3650, -27322, -21845, 200, 571, 908, 21830, 28946, -15701, -14010), shortArrayOf(
                8741,
                12,
                -1506,
                -22374,
        ...
        fun method2800(i: Int, i_3_: Int, i_4_: Int, i_5_: Int, i_6_: Int, i_7_: Int, i_8_: Int, i_9_: Int, i_10_: Byte, i_11_: Int) {
            anInt6734++
            if (i_10_ >= 118) {
        ...
        init {
            anIntArrayArray6740 = arrayOf<IntArray?>(intArrayOf(6, 6), intArrayOf(6, 6), intArrayOf(6, 5, 5), intArrayOf(5, 6, 5), intArrayOf(5, 5, 6), intArrayOf(6, 5, 5), intArrayOf(5, 0, 4, 1), intArrayOf(7, 7, 1, 2), intArrayOf(7, 1, 2, 7), intArrayOf(8, 9, 4, 0, 8, 9), intArrayOf(0, 8, 9, 8, 9, 4), intArrayOf(11, 0, 10, 11, 4, 2), intArrayOf(6, 6), intArrayOf(7, 7, 1, 2), intArrayOf(7, 7, 1, 2))
            aShortArrayArray6749 = arrayOf<ShortArray?>(ShortArray(0), ShortArray(0), ShortArray(0), ShortArray(0), ShortArray(0))
            aShortArrayArray6744 = (arrayOf<ShortArray?>(
                shortArrayOf(6554, 115, 10304, 28, 5702, 7756, 5681, 4510, -31835, 22437, 2859, -11339, 16, 5157, 10446, 3658, -27314, -21965, 472, 580, 784, 21966, 28950, -15697, -14002), shortArrayOf(
                    9104,
                    10275,
                    7595,
                    3610,
                    ...
                    8466,
                    -25537
                ), shortArrayOf(4540, 4529, 5674, 5667, 5785, 6802, 8072, 4562, 4437, 4317, 5896, 4488)
            ))
            aLong6748 = 0L

...
final class JavaSceneGraph extends Ground {
        ...
        if (!bool_74_) {
            ...
            for (int i_91_ = 0; i_91_ < i_79_; i_91_++) {
                if (is_67_[i_91_] >= 0 || is_68_ != null && is_68_[i_91_] >= 0) {
                    if (is_67_[i_91_] >= 0) class236.anIntArray3093[class236.aShort3099] = SkyBoxSphereTypeList.method303(is_67_[i_91_], 30);
                    else class236.anIntArray3093[class236.aShort3099] = -1;
                    if (is_68_ != null) {
                        if (is_68_[i_91_] != -1) class236.anIntArray3092[class236.aShort3099] = SkyBoxSphereTypeList.method303(is_68_[i_91_], 30);
            ...
            if (textureMetrics != null && (class102.aByte1606 & 0x2) == 0 && !textureMetrics.disableable) {
                ...
                if (method3997(textureMetrics.effectType) || textureMetrics.speedU != 0 || textureMetrics.speedV != 0) class102.aByte1606 |= 0x4;
            } else {
                short i_94_ = SkyBoxSphereTypeList.method303(i_92_, 30);
    ...
    private final void method3990(int i, int i_105_, boolean bool, JavaThreadResource javaThreadResource, Rasterizer rasterizer, int[] is, int[] is_106_, int[] is_107_, int[] is_108_, int i_109_) {
    ...
    private final void method3993(int i, int i_260_, int i_261_, int i_262_, int i_263_, int i_264_, int i_265_, boolean[][] bools, JavaThreadResource javaThreadResource, Rasterizer rasterizer, int[] is, int[] is_266_) {
    ...
    private final void method3996(int i, int i_453_, int i_454_, int i_455_, int i_456_, int i_457_, int i_458_, boolean[][] bools, JavaThreadResource javaThreadResource, Rasterizer rasterizer, int[] is, int[] is_459_) {

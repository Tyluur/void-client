    ...
    final byte[] method1161(byte i, int i_2_) {
        ...
        synchronized (aClass78_1933) {
            try {
                ...
                aClass78_1938.method788(0, Option.aByteArray3144, 6, i + -16713);
                int i_3_ = ((0xff & Option.aByteArray3144[2]) + ((0xff00 & Option.aByteArray3144[1] << 8) + (0xff0000 & Option.aByteArray3144[0] << 16)));
                int i_4_ = ((0xff & Option.aByteArray3144[5]) + ((0xff & Option.aByteArray3144[3]) << 16) - -((Option.aByteArray3144[4] & 0xff) << 8));
                ...
                while (i_3_ > i_5_) {
                    ...
                    aClass78_1933.method788(0, Option.aByteArray3144, 8 + i_7_, i ^ 0x414f);
                    int i_8_ = ((0xff00 & Option.aByteArray3144[0] << 8) + (Option.aByteArray3144[1] & 0xff));
                    int i_9_ = ((Option.aByteArray3144[2] << 8 & 0xff00) + (Option.aByteArray3144[3] & 0xff));
                    int i_10_ = (((Option.aByteArray3144[5] & 0xff) << 8) + (0xff0000 & Option.aByteArray3144[4] << 16) + (Option.aByteArray3144[6] & 0xff));
                    int i_11_ = 0xff & Option.aByteArray3144[7];
                    ...
                    for (int i_12_ = 0; i_12_ < i_7_; i_12_++)
                        is[i_5_++] = Option.aByteArray3144[8 + i_12_];
                }
                return is;
        ...
        synchronized (aClass78_1933) {
            try {
                ...
                if (bool) {
                    ...
                    aClass78_1938.method788(0, Option.aByteArray3144, 6, -16717);
                    i_15_ = ((0xff & Option.aByteArray3144[5]) + ((0xff & Option.aByteArray3144[3]) << 16) + ((Option.aByteArray3144[4] & 0xff) << 8));
                    if (i_15_ <= 0 || (aClass78_1933.method787(i ^ ~0x3af7) / 520L < (long) i_15_)) return false;
                } else {
                    i_15_ = (int) ((519L + aClass78_1933.method787(0)) / 520L);
                    if (i_15_ == 0) i_15_ = 1;
                }
                Option.aByteArray3144[0] = (byte) (i_14_ >> 16);
                Option.aByteArray3144[4] = (byte) (i_15_ >> 8);
                Option.aByteArray3144[2] = (byte) i_14_;
                Option.aByteArray3144[1] = (byte) (i_14_ >> 8);
                Option.aByteArray3144[3] = (byte) (i_15_ >> 16);
                Option.aByteArray3144[5] = (byte) i_15_;
                aClass78_1938.method789(i_13_ * 6, (byte) 111);
                aClass78_1938.method783(0, 6, true, Option.aByteArray3144);
                int i_16_ = 0;
                ...
                while (i_16_ < i_14_) {
                    ...
                    if (bool) {
                        ...
                        try {
                            aClass78_1933.method788(0, Option.aByteArray3144, 8, -16717);
                        } catch (java.io.EOFException eofexception) {
                            break;
                        }
                        int i_19_ = ((0xff & Option.aByteArray3144[1]) + (0xff00 & (Option.aByteArray3144[0] << 8)));
                        i_18_ = ((0xff00 & Option.aByteArray3144[5] << 8) + (((Option.aByteArray3144[4] & 0xff) << 16) - -(0xff & Option.aByteArray3144[6])));
                        int i_20_ = ((Option.aByteArray3144[2] << 8 & 0xff00) + (Option.aByteArray3144[3] & 0xff));
                        int i_21_ = 0xff & Option.aByteArray3144[7];
                    ...
                    Option.aByteArray3144[3] = (byte) i_17_;
                    Option.aByteArray3144[2] = (byte) (i_17_ >> 8);
                    Option.aByteArray3144[0] = (byte) (i_13_ >> 8);
                    Option.aByteArray3144[1] = (byte) i_13_;
                    Option.aByteArray3144[5] = (byte) (i_18_ >> 8);
                    Option.aByteArray3144[6] = (byte) i_18_;
                    Option.aByteArray3144[7] = (byte) anInt1932;
                    Option.aByteArray3144[4] = (byte) (i_18_ >> 16);
                    aClass78_1933.method789(520 * i_15_, (byte) -121);
                    aClass78_1933.method783(0, 8, true, Option.aByteArray3144);

...
final class Class16 {
    ...
    static final void method258(int i, int i_0_) {
        ...
        for (int i_1_ = 0; i_1_ < 3; i_1_++) {
            Class357 class357_2_ = (Class147.aClass357ArrayArrayArray2029[i_1_][i][i_0_] = Class147.aClass357ArrayArrayArray2029[i_1_ + 1][i][i_0_]);
            if (class357_2_ != null) {
        ...
        if (Class147.aClass357ArrayArrayArray2029[0][i][i_0_] == null) {
            Class147.aClass357ArrayArrayArray2029[0][i][i_0_] = new Class357(0);
            Class147.aClass357ArrayArrayArray2029[0][i][i_0_].aByte4399 = (byte) 1;
        }
    ...
    static final int method260(boolean bool) {
        ...
        anInt232++;
        if (Packet.anInt7207 == 1) return TextureOpPerlinNoise.anInt9157;
        return 0;
    }

...
final class s_Sub3 extends Ground {
    ...
    private HashTable aHashTable_8325;
    ...
    final void YA() {
        if (anInt8329 <= 0) aClass330_8307 = null;
            ...
            Class348_Sub3[] class348_sub3s = new Class348_Sub3[aHashTable_8325.size(1)];
            aHashTable_8325.toArray(3, class348_sub3s);
            ...
            if (i_48_ < 1) i_48_ = 1;
            HashTable hashTable = new HashTable(i_48_);
                ...
                for (int i_51_ = 0; (i_51_ < this.anInt4590); i_51_++) {
                    if (this.anIntArrayArrayArray8296[i_50_][i_51_] != null) {
                        ...
                        for (int i_78_ = 0; i_78_ < is_56_.length; i_78_++) {
                            ...
                            Node node = null;
                            if ((i_79_ & anInt8311 - 1) == 0 && (-1 + anInt8311 & i_80_) == 0) node = hashTable.get(l, -6008);
                            int i_105_;
                            if (node == null) {
                                int i_106_;
                                if (i_84_ != i_83_) {
                                ...
                                hashTable.put((byte) 108, l, new Class348_Sub29(is_77_[i_78_]));
                            } else {
    ...
    s_Sub3(NativeToolkit var_nativeToolkit, int i, int i_139_, int i_140_, int i_141_, int[][] is, int[][] is_142_, int i_143_) {
        ...
        do {
            try {
                ...
                aFloat8306--;
                aFloat8305++;
                aHashTable_8325 = new HashTable(128);
    ...
    final void U(int i, int i_167_, int[] is, int[] is_168_, int[] is_169_, int[] is_170_, int[] is_171_, int[] is_172_, int[] is_173_, int[] is_174_, int i_175_, int i_176_, int i_177_, boolean bool) {
        try {
            ...
            for (int i_178_ = 0; i_178_ < is_171_.length; i_178_++) {
                ...
                Node node;
                for (node = aHashTable_8325.get(l, -6008); node != null; node = aHashTable_8325.nextWithKey(true)) {
                ...
                if (node == null) {
                    ...
                    aHashTable_8325.put((byte) 27, l, class348_sub3s[i_178_]);

...
final class Option_Sub5 extends Option {
    ...
    Option_Sub5(ClientOptions clientOptions) {
        super(clientOptions);
    }
    ...
    static final boolean method1740(int i, int i_2_, boolean bool) {
        ...
        anInt5890++;
        return Option_Sub26.method1833((byte) -128, i_2_, i) || Class348_Sub42_Sub8_Sub2.method3200(i_2_, i, (byte) 96);
    }
    ...
    Option_Sub5(int i, ClientOptions clientOptions) {
    ...
    static final Class110_Sub1 method1742(boolean bool, int i) {
        ...
        anInt5885++;
        if (!Class195.aBoolean5013 || Class318_Sub1_Sub2.anInt8731 > i || Option_Sub29.anInt6151 < i) return null;

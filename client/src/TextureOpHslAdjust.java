...
final class TextureOpHslAdjust extends TextureOp {
            ...
            try {
                ...
                if (string != null) {
                    if (anInt9383 >= 200 && !Class206.isMember || anInt9383 >= 200) {
                        Class59.method544((Class274.aClass274_3493.method2063(AnimBase.language, 544)), false, 4);
                        String string_0_ = Class274.aClass274_3494.method2063(AnimBase.language, 544);
                        ...
                        if (string_1_ != null) {
                            for (int i_2_ = 0; (anInt9383 > i_2_); i_2_++) {
                                ...
                                if (string_3_ != null && string_3_.equals(string_1_)) {
                                    Class59.method544((string + (Class274.aClass274_3521.method2063((AnimBase.language), 544))), false, 4);
                                    return;
                                }
                            ...
                            for (int i_5_ = 0; i_5_ < Class348_Sub42_Sub12.anInt9604; i_5_++) {
                                ...
                                if (string_6_ != null && string_6_.equals(string_1_)) {
                                    Class59.method544(((Class274.aClass274_3526.method2063(AnimBase.language, 544)) + string + (Class274.aClass274_3527.method2063(AnimBase.language, 544))), false, 4);
                                    return;
                                }
                                if (TextureOp37.aStringArray9275[i_5_] != null) {
                                    String string_7_ = (Class285_Sub1.method2127(2, (TextureOp37.aStringArray9275[i_5_])));
                            ...
                            if (Class285_Sub1.method2127(2, (Class132.aPlayer_1907.aString10544)).equals(string_1_)) Class59.method544((Class274.aClass274_3524.method2063(AnimBase.language, 544)), false, 4);
                            else {
                                Class146.anInt2012++;
    ...
    final int[][] colourOutput(int i, int i_8_) {
        anInt9393++;
        int[][] is = this.colourCache.get(-105, i);
        if (this.colourCache.dirty) {
            int[][] is_9_ = this.outputColour((byte) 50, i, 0);
            int[] is_10_ = is_9_[0];
            int[] is_11_ = is_9_[1];
            int[] is_12_ = is_9_[2];
            int[] is_13_ = is[0];

        ...
        if (Class73.anInt4776 < 400) {
            if (Class132.aPlayer_1907 == player) {
                if (r.aBoolean9722 && (Class38.anInt500 & 0x10) != 0) {
                    Class32.anInt450++;
                    Class50_Sub3.method466(false, (Class28.aString5000 + " -> <col=ffffff>" + Class274.aClass274_3520.method2063(AnimBase.language, 544)), 0, (byte) -109, false, 0, -1, true, 50, player.anInt10290, Class28.aString5001, 0L, Class348_Sub49_Sub1.anInt9747);
                }
            } else {
                String string;
                if (player.anInt10564 == 0) {
                    ...
                    String string_5_ = ((Class14_Sub4.aClass230_8638 == Class348_Sub42_Sub8_Sub2.modeGame) ? Class274.aClass274_3513.method2063(AnimBase.language, 544) : Class274.aClass274_3511.method2063(AnimBase.language, 544));
                ...
                else string = (player.method2456(true, 255) + " (" + Class274.aClass274_3512.method2063(AnimBase.language, 544) + player.anInt10564 + ")");
                ...
                if (bool) Class50_Sub3.method466(true, "", 0, (byte) -115, false, 0, 0, false, -1, player.anInt10290, "<col=cccccc>" + string, 0L, -1);
                    ...
                    for (int i_6_ = 7; i_6_ >= 0; i_6_--) {
                        if (Class318_Sub1_Sub2_Sub1.aStringArray10195[i_6_] != null) {
                            short i_7_ = 0;
                            if ((Class348_Sub42_Sub8_Sub2.modeGame != Class10.aClass230_186) || !(Class318_Sub1_Sub2_Sub1.aStringArray10195[i_6_].equalsIgnoreCase(Class274.aClass274_3506.method2063(AnimBase.language, 544)))) {
                ...
                if (!bool) {
                    for (Class348_Sub42_Sub12 class348_sub42_sub12 = (Class348_Sub42_Sub12) TextureOpVerticalGradient.aDeque_9111.method1995(4); class348_sub42_sub12 != null; class348_sub42_sub12 = ((Class348_Sub42_Sub12) TextureOpVerticalGradient.aDeque_9111.method1990((byte) 105))) {
